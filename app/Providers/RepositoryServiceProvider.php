...
use App\Repositories\Eloquent\UserSecurityRepository;
use App\Repositories\Eloquent\UserWishlistRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    protected function registerBindings(): void
    {
        ...
        $this->app->bind(UserWishlistRepositoryInterface::class, UserWishlistRepository::class);
