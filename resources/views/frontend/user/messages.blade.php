                                ...
                                <a href="javascript:void(0);" class="notify-block d-flex open-chat">
                                    <div class="media-img-wrap flex-shrink-0">
                                        <div class="avatar avatar">
                                            <img src="{{ uploadedAsset($receiver->userDetail ? $receiver->userDetail->profile_image : 'default','profile') }}"  id="profileavatar" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body chat-custom flex-grow-1">
                                        <div>
                                            <div class="user-name">{{$receiver->name}}</div>
                                            <div class="user-last-chat">{{ $lastMessage ? strlen($lastMessage->message) > 20 ? substr($lastMessage->message, 0, 20).'...' : $lastMessage->message : '' }}</div>
                                        </div>
                                        <div>
                    ...
                    <div class="chat-cont-right">
                        <div class="chat-header">
                            ...
                            <div class="notify-block d-flex">
                                <div class="media-img-wrap flex-shrink-0">
                                    <div class="avatar avatar">
                                        <img src="{{ uploadedAsset($receiver->userDetail ? $receiver->userDetail->profile_image : 'default','profile') }}"  class="avatar-img rounded-circle">
                                    </div>
                                </div>
                        ...
                        <div class="chat-footer">
                            <div class="input-group">
                                ...
                                <button type="button" class="btn msg-send-btn rounded-pill ms-2" id="sendmsg"><i class="fa-solid fa-paper-plane"></i></button>
                            </div>
                        </div>
                    </div>
                    <!-- /Chat Right -->
...
<script src="{{ asset('frontend/assets/js/custom/user/messages.js?v=1.2') }}"></script>
@endpush