    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ __('web.home.leave_review') }}</h4>
                                ...
                                <div class="col-xl-6 col-md-6 col-lg-6">
                                    <div class="set-rating">
                                        ...
                                        <div class="rating-selection" id="service_ratings">
                                            ...
                                            <label for="service1"><span class="visually-hidden">1</span></label>
                                            <input type="checkbox" id="service2" class="service_ratings" value="2">
                                            <label for="service2"><span class="visually-hidden">2</span></label>
                                            <input type="checkbox" id="service3" class="service_ratings" value="3">
                                            <label for="service3"><span class="visually-hidden">3</span></label>
                                            <input type="checkbox" id="service4" class="service_ratings" value="4">
                                            <label for="service4"><span class="visually-hidden">4</span></label>
                                            <input type="checkbox" id="service5" class="service_ratings" value="5">
                                            <label for="service5"><span class="visually-hidden">5</span></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6 col-lg-6">
                                    <div class="set-rating">
                                        ...
                                        <div class="rating-selection" id="location_ratings">
                                            ...
                                            <label for="loc1"><span class="visually-hidden">1</span></label>
                                            <input type="checkbox" id="loc2" class="location_ratings" value="2">
                                            <label for="loc2"><span class="visually-hidden">2</span></label>
                                            <input type="checkbox" id="loc3" class="location_ratings" value="3">
                                            <label for="loc3"><span class="visually-hidden">3</span></label>
                                            <input type="checkbox" id="loc4" class="location_ratings" value="4">
                                            <label for="loc4"><span class="visually-hidden">4</span></label>
                                            <input type="checkbox" id="loc5" class="location_ratings" value="5">
                                            <label for="loc5"><span class="visually-hidden">5</span></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6 col-lg-6">
                                    <div class="set-rating">
                                        ...
                                        <div class="rating-selection" id="facility_ratings">
                                            ...
                                            <label for="fac1"><span class="visually-hidden">1</span></label>
                                            <input type="checkbox" id="fac2" class="facility_ratings" value="2">
                                            <label for="fac2"><span class="visually-hidden">2</span></label>
                                            <input type="checkbox" id="fac3" class="facility_ratings" value="3">
                                            <label for="fac3"><span class="visually-hidden">3</span></label>
                                            <input type="checkbox" id="fac4" class="facility_ratings" value="4">
                                            <label for="fac4"><span class="visually-hidden">4</span></label>
                                            <input type="checkbox" id="fac5" class="facility_ratings" value="5">
                                            <label for="fac5"><span class="visually-hidden">5</span></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6 col-lg-6">
                                    <div class="set-rating">
                                        ...
                                        <div class="rating-selection" id="value_for_money_ratings">
                                            ...
                                            <label for="val1"><span class="visually-hidden">1</span></label>
                                            <input type="checkbox" id="val2" class="value_for_money_ratings" value="2">
                                            <label for="val2"><span class="visually-hidden">2</span></label>
                                            <input type="checkbox" id="val3" class="value_for_money_ratings" value="3">
                                            <label for="val3"><span class="visually-hidden">3</span></label>
                                            <input type="checkbox" id="val4" class="value_for_money_ratings" value="4">
                                            <label for="val4"><span class="visually-hidden">4</span></label>
                                            <input type="checkbox" id="val5" class="value_for_money_ratings" value="5">
                                            <label for="val5"><span class="visually-hidden">5</span></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6 col-lg-6">
                                    <div class="set-rating">
                                        ...
                                        <div class="rating-selection" id="cleanliness_ratings">
                                            ...
                                            <label for="clean1"><span class="visually-hidden">1</span></label>
                                            <input type="checkbox" id="clean2" class="cleanliness_ratings" value="2">
                                            <label for="clean2"><span class="visually-hidden">2</span></label>
                                            <input type="checkbox" id="clean3" class="cleanliness_ratings" value="3">
                                            <label for="clean3"><span class="visually-hidden">3</span></label>
                                            <input type="checkbox" id="clean4" class="cleanliness_ratings" value="4">
                                            <label for="clean4"><span class="visually-hidden">4</span></label>
                                            <input type="checkbox" id="clean5" class="cleanliness_ratings" value="5">
                                            <label for="clean5"><span class="visually-hidden">5</span></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
