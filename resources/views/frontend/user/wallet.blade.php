                    ...
                    <div class="card wallet-card flex-fill">
                        <div class="card-body">
                                ...
                                <div class="balance-list">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6">
                                            <div class="balance-grid mb-0">
                                                <div class="balance-content">
                                                    <h6 class="mb-1">{{ __('web.user.available_balance') }}</h6>
                            ...
                            <div class="wallet-btn d-flex align-items-center wallet-inpts">
                                ...
                                <a href="javascript:void(0);" class="btn btn-sm open-wallet-modal">
                                    {{ __('web.user.add_payment') }}
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-0">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    <h5>{{ __('web.user.wallet_usage_history') }}</h5>
                                </div>
