            ...
            <div class="modal-body">
                <div class="booking-header">
                    <div class="booking-img-wrap">
                        ...
                        <div class="book-info">
                            <h6 class="bk-name">
                                <span class="visually-hidden">{{ __('web.home.name') }}</span>
                            </h6>
            ...
            <div class="modal-body">
                <form action="" id="cancelRideForm">
                    ...
                    <div class="modal-item">
                        ...
                        <textarea class="form-control cancel-reason" name="cancel_reason" id="cancel_reason" rows="4" cols="30"></textarea>
            ...
            <div class="modal-body">
                <form action="#">
                    <div class="modal-form-group">
                        ...
                        <input type="date" class="form-control" name="custom_from_date" id="custom_from_date">
                    </div>
                    <div class="modal-form-group">
                        <label for="custom_to_date">{{__('web.common.end_date')}} <span class="text-danger">*</span></label>
                        <input type="date" class="form-control" name="custom_to_date" id="custom_to_date">
                    </div>
