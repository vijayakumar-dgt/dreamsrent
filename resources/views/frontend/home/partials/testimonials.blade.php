            ...
            <div class="testimonial-item d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        ...
                        <div class="review-box">
                            <div class="review-profile">
                                <div class="review-img">
                                    <img src="{{ $testimonial->image }}" class="img-fluid" alt="{{ $testimonial->customer_name }}">
                                </div>
                            </div>
                        ...
                        @php
                            $limit = 225;
                            $shortReview = strlen($testimonial->review) > $limit ? substr($testimonial->review, 0, $limit) . '...' : $testimonial->review;
                        @endphp
                        <p>{{ $shortReview }}</p>
