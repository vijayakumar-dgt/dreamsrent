<section class="car-section">
    <div class="container">
                ...
                <div class="listing-item listing-item-two">
                    ...
                    <div class="listing-content">
                        <div class="listing-features d-flex align-items-center justify-content-between">
                            <div class="list-rating">
                                ...
                                <div class="list-rating">
                                    ...
                                    <span>({{ number_format($rating, 1) }}) {{ $content['review_count'] ?? 0 }} {{ __('web.common.reviews') }}</span>
                                </div>
                            </div>
                            <div>
                                @php
                        ...
                        <div class="listing-details-group">
                            <ul>
                                <li>
                                    <img src="/frontend/assets/img/icons/car-parts-01.svg" alt="{{ $content['transmission'] ?? '' }}">
                                    <p>{{ $content['transmission'] ?? "" }}</p>
                                </li>
                                <li>
                                    <img src="/frontend/assets/img/icons/car-parts-02.svg" alt="{{ $content['mileage'] ? round($content['mileage']) : '' }} KM">
        ...
        <div class="view-all-btn text-center aos" data-aos="fade-down">
            <a href="{{ route('list') }}" class="btn btn-secondary d-inline-flex align-items-center">{{ __('web.home.view_all_cars') }}<i class="bx bx-right-arrow-alt ms-1"></i></a>
        </div>
    </div>
</section>
