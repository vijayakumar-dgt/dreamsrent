                ...
                <div class="star-rated">
                    ...
                    <div class="camaro-info">
                        <h3 class="vehicle_name">
                            <span class="visually-hidden">{{ __('web.home.vehicle_name') }}</span>
                        </h3>
                            ...
                            <div class="row">
                                <div class="featureslist d-flex align-items-center col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="featues-info">
                                        ...
                                        <h6 class="vehicle_type">
                                            <span class="visually-hidden">{{ __('web.home.body') }}</span>
                                        </h6>
                                    </div>
                                </div>
                                <div class="featureslist d-flex align-items-center col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="featues-info">
                                        ...
                                        <h6 class="vehicle_brand">
                                            <span class="visually-hidden">{{ __('web.home.make') }}</span>
                                        </h6>
                                    </div>
                                </div>
                                <div class="featureslist d-flex align-items-center col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="featues-info">
                                        ...
                                        <h6 class="vehicle_transmission">
                                            <span class="visually-hidden">{{ __('web.home.transmission') }}</span>
                                        </h6>
                                    </div>
                                </div>
                                <div class="featureslist d-flex align-items-center col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="featues-info">
                                        ...
                                        <h6 class="vehicle_fuel">
                                            <span class="visually-hidden">{{ __('web.home.fuel_type') }}</span>
                                        </h6>
                                    </div>
                                </div>
                                <div class="featureslist d-flex align-items-center col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="featues-info">
                                        ...
                                        <h6 class="vehicle_mileage">
                                            <span class="visually-hidden">{{ __('web.home.mileage') }}</span>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="featureslist d-flex align-items-center col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="featues-info">
                                        ...
                                        <h6 class="vehicle_year">
                                            <span class="visually-hidden">{{ __('web.home.year') }}</span>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="featureslist d-flex align-items-center col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="featues-info">
                                        ...
                                        <h6 id="vin">
                                            <span class="visually-hidden">{{ __('web.home.vin') }}</span>
                                        </h6>
                                    </div>
                                </div>
                                <div class="featureslist d-flex align-items-center col-xl-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="featues-info">
                                        ...
                                        <h6 class="vehicle_hatch">
                                            <span class="visually-hidden">{{ __('web.home.hatch') }}</span>
                                        </h6>
                                        @else
                                        <span>{{ __('web.home.door') }} </span>
                                        <h6 class="vehicle_doors">
                                            <span class="visually-hidden">{{ __('web.home.door') }}</span>
                                        </h6>
                                        @endif
                                    </div>
                                </div>
