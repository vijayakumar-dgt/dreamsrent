                    ...
                    <div class="col-lg-6 col-md-6 d-lg-flex">
                        <div class="blog grid-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title"><a href="/blog-details/{{$blogPost->slug}}">{{$blogPost->title}}</a></h3>
                                ...
                                <ul class="meta-item">
                                    ...
                                    <img src="{{ file_exists(public_path($imagePath)) ? asset($imagePath) : $defaultImage }}" alt="author">
                                            ...
                                            <a href="javascript:void(0)"> <span><a href="javascript:void(0)"> <span> {{$blogPost->customer}} </span></a></span></a>
                                        </div>
                                    </li>
                                    <li class="date-icon"><i class="fa-solid fa-calendar-days"></i> <span>{{ \Carbon\Carbon::parse($blogPost->created_at)->format('d M Y') }}</span></li>
                                </ul>
                                <a href="/blog-details/{{$blogPost->slug}}" class="viewlink btn btn-primary">{{__('web.blog.read_more')}} <i class="feather-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
                    ...
                    <div class="card mb-0">
                        ...
                        <div class="article">
                            ...
                            <div class="article-content">
                                <h5><a href="/blog-details/{{$latest->id}}">{{$latest->title}}</a></h5>
