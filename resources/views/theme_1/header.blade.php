                ...
                <li class="nav-item">
                    <div class="nav-item dropdown has-arrow flag-nav flag-nav1 nav-item-box">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);"
                            role="button">
                            <img src="{{ asset('/assets/img/flag/'. app()->getLocale() .'.svg') }}" alt="Language" class="img-fluid">
                        </a>
                                ...
                                @foreach ($allLanguages as $language)
                                    <li>
                                        <a href="javascript:void(0);" class="dropdown-item change-user-language" data-id="{{ $language->id }}" data-language_code="{{ $language->code }}">
                                            <img src="{{ asset('/assets/img/flag/'. $language->code.'.svg') }}" alt="" height="16">
                                            {{ $language->name }}
                                        </a>
                                    </li>
                                @endforeach
                ...
                @if(Auth::guard('web')->check())
                    ...
                    <li class="nav-item dropdown logged-item noti-nav noti-wrapper">
                        <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                            <span class="bell-icon"><img src="{{ asset('frontend/assets/img/icons/bell-icon.svg') }}" alt="Bell"></span>
                        ...
                        <div class="dropdown-menu notifications">
                            <div class="topnav-dropdown-header">
                                ...
                                <a href="javascript:void(0)" class="clear-noti has-notification d-none" id="markAllAsRead"> {{ __('web.user.clear_all') }} </a>
                            </div>
                    ...
                    <li class="nav-item dropdown has-arrow logged-item">
                        <a href="#" class="dropdown-toggle  user-drop-down nav-link" data-bs-toggle="dropdown">
                            <span class="user-img">
                                <img class="rounded-circle header_profile_image" src="{{ getProfileImage() }}" width="31" alt="Profile" alt="Profile">
                            </span>
