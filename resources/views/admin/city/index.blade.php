...
@section('meta_title', __('admin.common.city') . ' || ' . $companyName)
...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.cms.locations')" :breadcrumbs="[
                ...
                ]" :buttonText="__('admin.cms.add_city')" :modalId="'city_modal'" :buttonId="'add_city'"
...
<!-- Add City -->
<x-admin.modal className="addmodal" id="city_modal" :title="__('admin.cms.create_city')" formId="cityForm"
    ...
    <x-slot name="body">
        ...
        <div class="mb-3">
            <label for="name" class="form-label">{{ __('admin.common.city') }} <span
        ...
        <div class="mb-3">
            <label for="state_id" class="form-label">{{ __('admin.common.state') }} <span
                    class="text-danger">*</span></label>
            ...
            <div class="form-check form-check-md form-switch me-2 d-none" id="statusDiv">
                <label class="form-check-label form-label mt-0 mb-0">
                    <input class="form-check-input form-label me-2 status" id="status" type="checkbox" role="switch"
                        checked name="status" aria-checked="true">
...
@push('scripts')
<script src="{{ asset('backend/assets/js/city.js') }}"></script>
@endpush
