                    ...
                    <div class="slimscroll">
                        ...
                        <div class="sidebar-body chat-body" id="chatsidebar">
                            <div class="chat-users-wrap">
                                ...
                                <div class="chat-list">
                                    <a href="javascript:void(0);" class="chat-user-list userprofile"
                                        data-userid="{{ $user->id }}"
                                        data-username="{{ getCurrentUserFullname($user->id) }}"
                                        data-avatar="{{ uploadedAsset($user->userDetail ? $user->userDetail->profile_image : 'default','profile') }}">
                                        <div class="avatar avatar-lg  me-2">
                                            <img src="{{ uploadedAsset($user->userDetail ? $user->userDetail->profile_image : 'default','profile') }}"
                                                class="rounded-circle avatarimg" alt="Profile">
                                        </div>
                    ...
                    <div class="chat-header">
                        <div class="user-details">
                            ...
                            <div class="avatar avatar-lg  flex-shrink-0">
                                <img src="{{ uploadedAsset('default','profile') }}" class="rounded-circle"
                                    id="chat_avatar" alt="Profile" data-userid="">
                            </div>
                    ...
                    <div class="footer-form d-flex align-items-center">
                        <div class="form-item input-group">
                            ...
                            <input type="text" class="form-control me-3" id="messageinput"
                                placeholder="{{ __('admin.others.type_your_message') }}">
