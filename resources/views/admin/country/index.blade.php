...
@section('meta_title', __('admin.common.country') . ' || ' . $companyName)
...
@section('content')
				...
				<div class="my-auto mb-2">
					...
					<nav>
						<ol class="breadcrumb mb-0">
							...
							<li class="breadcrumb-item active" aria-current="page">{{ __('admin.common.country') }}</li>
						</ol>
					</nav>
				</div>
	...
	<!-- Add Seat -->
	<div class="modal fade addmodal" id="country_modal">
		<div class="modal-dialog modal-dialog-centered modal-md">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="mb-0 modal-title">{{ __('admin.cms.create_country') }}</h4>
				...
				<form id="countryForm">
					...
					<div class="modal-body">                   
						...
						<div class="mb-3">
							<label class="form-label">{{ __('admin.cms.country_code') }}<span class="text-danger"> *</span></label>
