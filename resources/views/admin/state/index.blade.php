...
<x-admin.modal className="addmodal" id="state_modal" :title="__('admin.cms.create_state')" formId="stateForm"
    ...
    <x-slot name="body">
        ...
        <div class="mb-3">
            <label for="name" class="form-label">{{ __('admin.common.state') }}<span class="text-danger">
                    *</span></label>
        ...
        <div class="mb-3">
            <label for="country_id" class="form-label">{{ __('admin.common.country') }}<span class="text-danger">
                    *</span></label>
