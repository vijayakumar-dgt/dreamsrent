...
<div class="page-wrapper">
    <div class="content me-4">
        <div class="mb-3">
            <a href="invoices.html" class="d-inline-flex align-items-center fw-medium"><i class="ti ti-arrow-narrow-left me-2"></i>{{ __('admin.common.back_to_list') }}</a>
        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="select" name="status">
                                                    ...
                                                    <option value="Overdue" {{ $invoice->status == 'Overdue' ? 'selected' : '' }}>{{ __('admin.finance_accounts.overdue') }}</option>
                                                    <option value="Unpaid" {{ $invoice->status == 'Unpaid' ? 'selected' : '' }}>{{ __('admin.finance_accounts.unpaid') }}</option>
                                                </select>
                        ...
                        <div class="table-responsive border border-gray br-10 mb-3">
                            <table class="table">
                                ...
                                <tbody id="rental-details-body">
                                    ...
                                    <tr>
                                        <td class="pe-0">
                                            <input type="text" name="items[{{ $key }}][description]" class="form-control" value="{{ $item->description }}">
                                        </td>
                                        <td class="pe-0">
                                            <input type="number" name="items[{{ $key }}][qty]" class="form-control qty" value="{{ $item->qty }}">
                                        </td>
                                        <td class="pe-0">
                                            <input type="number" name="items[{{ $key }}][price]" class="form-control price" value="{{ $item->price }}">
                                        </td>
                                        <td class="pe-0">
                                            <input type="number" name="items[{{ $key }}][tax]" class="form-control" value="{{ $item->tax }}">
                                        </td>
                                        <td class="pe-0">
                                            <input type="number" name="items[{{ $key }}][total_price]" class="form-control total" value="{{ $item->total_price }}" readonly>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0);" class="btn btn-icon btn-sm text-danger delete-row"><i class="ti ti-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
