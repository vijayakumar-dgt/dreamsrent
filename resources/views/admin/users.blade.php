...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.common.users')" :breadcrumbs="[
                    __('admin.common.users') => ''
                ]" :buttonText="__('admin.user_management.add_new_user')" :modalId="'add_user_modal'"
            :buttonId="'add_user'" :permissionModule="'users'" />
        <!-- Table Header -->
        ...
        <div class="collapse" id="filtercollapse">
            <div class="filterbox mb-3 d-flex align-items-center">
                        ...
                        <div class="custom-scroll">
                            ...
                            <li>
                                <label class="dropdown-item d-flex align-items-center rounded-1">
                                    <input class="form-check-input m-0 me-2 role_checkbox" type="checkbox"
                ...
                <button type="button" class="text-purple links border-0 bg-transparent"
                    id="apply_filter">{{ __('admin.common.apply') }}</button>
                <button type="button" class="text-danger links border-0 bg-transparent"
                    id="reset_filter">{{ __('admin.common.clear_all') }}</button>
            </div>
        </div>
            ...
            <table class="table" id="userTable">
                <thead class="thead-light">
                    <tr>
                        ...
                        @if (hasPermission($permissions, 'users', 'edit') || hasPermission($permissions, 'users',
                        'delete'))
...
<!-- Add User -->
<x-admin.modal className="addmodal" id="add_user_modal" dialogClassName="modal-lg"
    :title="__('admin.user_management.create_user')" action="{{  route('admin.save-user') }}" formId="userForm"
    ...
    <x-slot name="body">
        <div class="row">
            <div class="mb-3">
                ...
                <div class="d-flex align-items-center flex-wrap row-gap-3">
                    <div
                        ...
                        <img src="{{ uploadedAsset('', 'profile') }}" class="img-fluid rounded d-none" id="imagePreview"
                            alt="Profile">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="first_name" class="form-label">{{ __('admin.common.first_name') }}<span
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="last_name" class="form-label">{{ __('admin.common.last_name') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="role_id" class="form-label">{{ __('admin.user_management.role') }}<span
                            class="text-danger"> *</span></label>
                    <select class="form-control role" name="role_id" id="role_id"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="password" class="form-label">{{ __('admin.common.auth_password') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="confirm_password" class="form-label">{{ __('admin.common.confirm_password') }}<span
                            class="text-danger"> *</span></label>
                    <div class="pass-group">
...
<!-- Edit User -->
<x-admin.modal className="addmodal" id="edit_user_modal" dialogClassName="modal-lg"
    :title="__('admin.user_management.edit_user')" action="{{  route('admin.save-user') }}" formId="editUserForm"
    method="POST" enctype="multipart/form-data">
    <x-slot name="body">
        ...
        <div class="row">
            <div class="mb-3">
                ...
                <div class="d-flex align-items-center flex-wrap row-gap-3">
                    <div
                        class="d-flex align-items-center justify-content-center avatar avatar-xxl border me-3 flex-shrink-0 text-dark frames">
                        <img src="{{ uploadedAsset('', 'profile') }}" class="img-fluid rounded d-none"
                            id="editImagePreview" alt="Profile">
                        <i class="ti ti-photo-up text-gray-4 fs-24 upload_icon"></i>
                    </div>
                    <div class="profile-upload">
                        <div class="profile-uploader d-flex align-items-center">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_first_name" class="form-label">{{ __('admin.common.first_name') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_last_name" class="form-label">{{ __('admin.common.last_name') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_role_id" class="form-label">{{ __('admin.user_management.role') }}<span
                            class="text-danger"> *</span></label>
                    <select class="form-control edit_role" name="role_id" id="edit_role_id"
                        data-placeholder="{{ __('admin.common.select') }}">
                        <option value="">{{ __('admin.common.select') }}</option>
                        @if ($roles)
                        @foreach ($roles as $role)
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_phone_number" class="form-label">{{ __('admin.common.phone_number') }}<span
                            class="text-danger"> *</span></label>
                    <input type="text" class="form-control edit_user_phone_number" id="edit_phone_number"
                        name="phone_number">
