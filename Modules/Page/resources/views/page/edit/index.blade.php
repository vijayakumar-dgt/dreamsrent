                            ...
                            <div class="card-body pb-1 d-none real-table">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="input-tags form-control" name="keyword" id="keyword" value="{{ $query->keywords }}" placeholder="{{ __('admin.page.keywords_placeholder') }}" type="text">
                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('admin.page.meta_title') }} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('admin.page.meta_keywords') }} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('admin.page.canonical_url') }} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __('admin.page.og_title') }} <span class="text-danger">*</span></label>
