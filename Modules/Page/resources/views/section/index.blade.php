...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.cms.section')" :breadcrumbs="[
...
<!-- /Page Wrapper -->
<x-admin.modal className="addmodal" id="add_banner_sec" :title="__('admin.cms.edit_section')" formId="addBannerOneForm"
    ...
    <x-slot name="body">
        ...
        <div id="section_id_8" class="d-none">
            <div class="row">
                <!-- Title -->
                <div class="form-group col-md-12">
                    <div class="mb-3">
        ...
        <div id="section_id_11" class="d-none">
            <div class="row">
                <!-- Title -->
                <div class="form-group col-md-12">
                    <div class="mb-3">
        ...
        <div id="section_id_13" class="d-none">
           ...
           <div id="section_id_14" class="d-none">
            <div class="row">
                <!-- Title -->
                <div class="form-group col-md-12">
                    <div class="mb-3">
