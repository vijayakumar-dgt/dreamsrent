    ...
    <div class="content me-4">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h4 class="mb-1">{{ __('admin.bookings.all_reservations') }}</h4>
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item">
                            <a href="{{ route('dashboard') }}">{{ __('admin.common.home') }}</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('admin.bookings.all_reservations') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap d-none">
                <div class="mb-2 me-2">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            <div class="d-flex align-items-center flex-wrap row-gap-3">
                ...
                <div class="skeleton label-skeleton label-loader me-2"></div>
                <div class="me-2 d-none real-label">
        ...
        <div class="modal-content">
            <form id="reservation_complete_form">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="javascript:void(0);" class="btn btn-light me-3" data-bs-dismiss="modal">{{ __('admin.common.cancel') }}</a>
                        <button type="submit" class="btn btn-primary">{{ __('admin.common.yes_complete') }}</a>
                    </div>
                </div>
            </form>
        </div>
