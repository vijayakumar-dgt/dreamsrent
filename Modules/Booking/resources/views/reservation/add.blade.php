...
@section('meta_title', __('admin.bookings.add_reservation') . ' || ' . $companyName)
            ...
            <fieldset id="first-field">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <a href="{{ route('reservation.index') }}" class="btn btn-danger w-100"><i class="ti ti-x me-1"></i>{{ __('admin.bookings.cancel_booking') }}</a>
                    </div>
                </div>
            </fieldset>
...
<x-admin.modal
    ...
    <x-slot name="body">
        <div class="row pb-1">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label class="form-label">
                        {{ __('admin.common.pricing') }}<span class="text-danger"> *</span>
                    </label>
    ...
    <x-slot name="footer">
        <div class="d-flex justify-content-center">
            ...
            <button type="submit" class="btn btn-primary driver_price_btn">
...
@push('scripts')
<script src="{{ asset('backend/assets/js/booking/add-reservation.js') }}"></script>
@endpush