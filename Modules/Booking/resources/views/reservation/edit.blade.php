...
<!-- Completed -->
<x-admin.modal id="reservation_completed" size="sm" type="deletemodal">
    <div class="text-center">
        ...
        <p class="mb-3">
            {{ __('admin.bookings.reservation_updated_for_the') }}
...
<!-- Edit Pricing -->
<x-admin.modal id="edit_price_modal" size="md" type="addmodal" :title="__('admin.bookings.edit_pricing')">
...
<x-admin.modal id="booking_cancel_modal" size="md" type="addmodal" :title="__('admin.bookings.cancel_booking')">
