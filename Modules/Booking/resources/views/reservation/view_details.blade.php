                                    ...
                                    <div class="border-bottom mb-3 pb-2">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                            <h6 class="fw-medium d-flex align-items-center fs-14">{{ $booking->insurance_count }} {{ __('admin.common.insurances') }} 
                                                <a href="javascript:void(0);" class="me-2 ms-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="{{ !empty($booking->insurance_benefits) ? implode(', ', $booking->insurance_benefits) : '' }}"><i class="ti ti-info-circle-filled"></i></a>
                                            </h6>
...
@push('scripts')
<script src="{{ asset('assets/js/booking/reservation-details.js') }}"></script>
@endpush