        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                <div class="mb-2">
                    ...
                    <a href="{{ route('quotations.create') }}" class="btn btn-primary d-flex align-items-center d-none real-label"><i class="ti ti-plus me-2"></i>{{ __('admin.bookings.add_new_quotation') }}</a>
                    @endif
                </div>
            </div>
        </div>
...
@push('scripts')
<script src="{{ asset('assets/js/quotations/quotations.js') }}"></script>
@endpush