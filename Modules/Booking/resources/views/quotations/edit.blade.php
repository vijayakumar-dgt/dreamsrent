                                        ...
                                        <div class="col-lg-9 col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="base_km" id="base_km"
                                                                class="form-control Number" maxlength="4"
                                                                value="{{ old('base_km', $booking->base_km) }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="km_extra_price" class="form-label">Kilometers Extra Price</label>
                                                            <input type="text" name="km_extra_price" id="km_extra_price"
                                                                class="form-control Number" maxlength="4"
                                                                value="{{ old('km_extra_price', $booking->km_extra_price) }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="expenses" id="expenses"
                                                                class="form-control Number" maxlength="4"
                                                                value="{{ old('expenses', $booking->expenses) }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="delivery_price" id="delivery_price"
                                                                class="form-control Number" maxlength="4"
                                                                value="{{ old('delivery_price', $booking->delivery_price) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-lg-3 col-sm-12">
                                                    <div class="d-flex">
                                                        <div class="mb-3">
                                                            <h6 class="mb-1">Tax Settings</h6>
                                                            <p>Add Tax Settings</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="tax_val" id="tax_val"
                                                                    class="form-control"
                                                                    value="{{ old('tax_val', $booking->tax_val) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    <a href="#" class="avatar avatar-sm avatar-rounded me-2 flex-shrink-0"><img src="/custom/img/default-profile.png" class="edit_driver_img" alt=""></a>
                                    <div>
...
@push('scripts')
<script src="{{ asset('assets/js/quotations/edit-quotations.js') }}"></script>
@endpush