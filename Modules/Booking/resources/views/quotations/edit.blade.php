...
@section('meta_title', __('admin.bookings.edit_quotation') . ' || ' . $companyName)
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    <a href="#" class="avatar avatar-sm avatar-rounded me-2 flex-shrink-0"><img src="{{ asset('/backend/assets/img/default-profile.png') }}" class="edit_driver_img" alt=""></a>
                                    <div>
