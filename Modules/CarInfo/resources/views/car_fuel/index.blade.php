...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.fuel_types')" :breadcrumbs="[
					__('admin.rentals.fuel_types') => ''
				]" :buttonText="__('admin.rentals.add_new_fuel_type')" :modalId="'fuel_type_modal'" :buttonId="'add_fuel_type'"
...
<!-- Add/Edit Fuel -->
<x-admin.modal className="addmodal" id="fuel_type_modal" :title="__('admin.rentals.create_fuel_type')"
    action="{{  route('fuelType.update') }}" formId="fuelTypeForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <input type="hidden" name="language_id" id="language_id">
        <div class="mb-3">
            <label for="fuel_type" class="form-label">{{ __('admin.rentals.fuel_type') }}<span class="text-danger">
                    *</span></label>
