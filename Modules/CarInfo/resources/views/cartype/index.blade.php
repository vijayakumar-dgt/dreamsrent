...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.vehicle_types')" :breadcrumbs="[
                    __('admin.rentals.vehicle_types') => ''
                ]" :buttonText="__('admin.rentals.add_new_vehicle_type')" :modalId="'add_type'" :buttonId="'add_new_type'"
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu  dropdown-menu-end p-2">
                    <li>
                        <button type="button" class="dropdown-item rounded-1 status_filter"
...
<!-- Add/Edit Type Start-->
<x-admin.modal className="addmodal" id="add_type" :title="__('admin.rentals.create_type')"
    action="{{  route('storetype') }}" formId="typeForm" method="POST" enctype="multipart/form-data">
    <x-slot name="body">
        ...
        <div class="row mb-3">
            <label for="icon_preview" class="form-label">{{ __('admin.common.icon') }} <span
                    class="text-danger icon_asterisk">*</span></label>
            <div class="col-md-4">
                <div
                    class="d-flex align-items-center justify-content-center avatar avatar-xxxl border border-dashed me-2 flex-shrink-0 text-dark frames">
                    <img src="{{ uploadedAsset('', 'default') }}" id="icon_preview" class="img-contain rounded d-none"
                        alt="Icon">
