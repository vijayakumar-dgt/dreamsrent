		...
		<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
			...
			<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
				...
				<div class="mb-2 d-none">
					<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_enquiry_modal" id="add_enquiry" class="btn btn-primary d-flex align-items-center"><i class="ti ti-plus me-2"></i>{{ __('admin.bookings.add_new_enquiry') }}</a>
				</div>
			</div>
		</div>
		<!-- /Breadcrumb -->
