...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content me-4">
            <x-admin.breadcrumb :title="__('admin.common.enquiries')" :breadcrumbs="[
                ...
                <div class="d-flex align-items-center flex-wrap row-gap-3">
                    ...
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end p-2 sort_by_list">
                            <li><button type="button" class="dropdown-item rounded-1 active-sort"
                                    data-value="latest">{{ __('admin.common.latest') }}</button></li>
                            <li><button type="button" class="dropdown-item rounded-1 active-sort"
                                    data-value="ascending">{{ __('admin.common.ascending') }}</button></li>
                            <li><button type="button" class="dropdown-item rounded-1 active-sort"
                                    data-value="descending">{{ __('admin.common.descending') }}</button></li>
                            <li><button type="button" class="dropdown-item rounded-1 active-sort"
                                    data-value="last_7_days">{{ __('admin.common.last_7_days') }}</button></li>
                            <li><button type="button" class="dropdown-item rounded-1 active-sort"
                                    data-value="last_month">{{ __('admin.common.last_month') }}</button></li>
                        </ul>
                    </div>
                    <!-- Status Dropdown -->
                    <div class="dropdown">
                        <button type="button" class="dropdown-toggle btn btn-white d-inline-flex align-items-center"
                            data-bs-toggle="dropdown">
                            <i class="ti ti-badge me-1 status"></i> {{ __('admin.common.status') }}: <span class="ms-1"
                                id="current_status">{{ __('admin.common.all') }}</span>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end p-2">
                            <li><button type="button" class="dropdown-item rounded-1 active-status"
                                    data-value="">{{ __('admin.common.all') }}</button></li>
                            <li><button type="button" class="dropdown-item rounded-1 active-status"
                                    data-value="1">{{ __('admin.common.not_opened') }}</button></li>
                            <li><button type="button" class="dropdown-item rounded-1 active-status"
                                    data-value="2">{{ __('admin.common.opened') }}</button></li>
                            <li><button type="button" class="dropdown-item rounded-1 active-status"
                                    data-value="3">{{ __('admin.common.closed') }}</button></li>
                        </ul>
                    </div>
                </div>
                <!-- Search Box -->
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                    <div class="top-search">
                        <div class="top-search-group">
                            ...
                            <input type="text" class="form-control enquiresearch"
    ...
    <!-- Edit Enquiry -->
    <x-admin.modal className="addmodal" id="edit_enquiry_modal" dialogClassName="modal-lg"
        :title="__('admin.bookings.edit_enquiry')" action="{{  route('enquire.update') }}" formId="editEnquiryForm"
        method="POST">
        <x-slot name="body">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <label for="comment" class="form-label">{{ __('admin.common.comments') }}<span class="text-danger">
                            *</span></label>
