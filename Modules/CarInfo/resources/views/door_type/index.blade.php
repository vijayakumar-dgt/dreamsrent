...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.door_types')" :breadcrumbs="[
					__('admin.rentals.door_types') => ''
				]" :buttonText="__('admin.rentals.add_new_door_type')" :modalId="'door_type_modal'" :buttonId="'add_door_type'"
...
<!-- Add/Edit Door Type -->
<x-admin.modal className="addmodal" id="door_type_modal" :title="__('admin.rentals.create_door_type')"
    action="{{  route('doorType.store') }}" formId="doorTypeForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <div class="mb-3">
            <label for="door_type" class="form-label">{{ __('admin.rentals.door_type') }}<span class="text-danger">
                    *</span></label>
