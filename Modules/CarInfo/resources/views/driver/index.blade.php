...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.manage.drivers')" :breadcrumbs="[
                    __('admin.manage.drivers') => ''
                ]" :buttonText="__('admin.manage.add_new_driver')" :modalId="'add_driver_modal'"
            :buttonId="'add_driver'" :permissionModule="'drivers'" />
        <!-- Table Header -->
        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
            <div class="d-flex align-items-center flex-wrap row-gap-3">
                ...
                <div class="dropdown me-2">
                    <button type="button" class="dropdown-toggle btn btn-white d-inline-flex align-items-center"
                        data-bs-toggle="dropdown">
                        <i class="ti ti-badge me-1"></i> <span class="ms-1"
                            id="current_sort_status">{{ __('admin.common.status') }}</span>
                    </button>
                    <ul class="dropdown-menu  dropdown-menu-end p-2" id="statusList">
                        <li>
                            <button type="button" class="dropdown-item rounded-1"
                                data-sort="1">{{ __('admin.common.active') }}</button>
                        </li>
                        <li>
                            <button type="button" class="dropdown-item rounded-1"
                                data-sort="0">{{ __('admin.common.inactive') }}</button>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                ...
                <div class="dropdown me-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-2">
                        <li>
                            <button type="button" class="dropdown-item rounded-1 bulk_status_change"
            ...
            <table class="table" id="driverTable">
                <thead class="thead-light">
                    <tr>
                        ...
                        @if (hasPermission($permissions, 'drivers', 'edit') || hasPermission($permissions, 'drivers',
                        'delete'))
...
<!-- Add Driver -->
<x-admin.modal className="addmodal" id="add_driver_modal" dialogClassName="modal-lg"
    :title="__('admin.manage.create_driver')" action="{{  route('driver.store') }}" formId="driverForm" method="POST"
    enctype="multipart/form-data">
    <x-slot name="body">
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    <label for="image" class="form-label">{{ __('admin.common.image') }}<span class="text-danger">
                            *</span></label>
                    <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                        <div
                            ...
                            <img src="{{ uploadedAsset('', 'profile') }}" id="imagePreview"
                                class="img-fluid rounded d-none" alt="Profile">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="driver_name" class="form-label">{{ __('admin.manage.driver_name') }}<span
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="gender" class="form-label">{{ __('admin.common.gender') }}<span class="text-danger">
                            *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="phone_number" class="form-label">{{ __('admin.common.phone_number') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="email" class="form-label">{{ __('admin.common.email') }}<span class="text-danger">
                            *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="address" class="form-label">{{ __('admin.common.address') }}<span class="text-danger">
                            *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="assigned_cars" class="form-label">{{ __('admin.manage.assigned_vehicles') }}<span
                            class="text-danger"> *</span></label>
                    <select class="select select2" id="assigned_cars" name="assigned_cars[]" data-placeholder="Select"
                        multiple>
                        @if ($cars)
                        @foreach ($cars as $car)
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="card_number" class="form-label">{{ __('admin.manage.card_number') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="date_of_issue" class="form-label">{{ __('admin.manage.date_of_issue') }}<span
                            class="text-danger"> *</span></label>
                    <input type="text" class="form-control date_of_issue" name="date_of_issue" id="date_of_issue"
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="valid_date" class="form-label">{{ __('admin.manage.valid_date') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    <label for="documents" class="form-label">{{ __('admin.common.documents') }}</label><span
                        class="text-danger"> *</span></label>
                    <div class="document-upload text-center br-3 mb-3">
                        ...
                        <p class="mb-2">{{ __('admin.common.drop_your_files_here_or') }} <span
                                class="text-info text-decoration-underline">{{ __('admin.common.browse') }}</span></p>
...
<!-- Edit Driver -->
<x-admin.modal className="addmodal" id="edit_driver_modal" dialogClassName="modal-lg"
    :title="__('admin.manage.edit_driver')" action="{{  route('driver.store') }}" formId="editDriverForm" method="POST"
    enctype="multipart/form-data">
    <x-slot name="body">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    <label for="edit_image" class="form-label">{{ __('admin.common.image') }}<span class="text-danger">
                            *</span></label>
                    <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                        <div
                            class="d-flex align-items-center justify-content-center avatar avatar-xxl border me-3 flex-shrink-0 text-dark frames">
                            <img src="{{ uploadedAsset('', 'profile') }}" id="editImagePreview"
                                class="img-fluid rounded d-none" alt="Profile">
                            <i class="ti ti-photo-up text-gray-4 fs-24 upload_icon"></i>
                        </div>
                        <div class="profile-upload">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_driver_name" class="form-label">{{ __('admin.manage.driver_name') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_gender" class="form-label">{{ __('admin.common.gender') }}<span
                            class="text-danger"> *</span></label>
                    <select class="select" id="edit_gender" name="gender"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_phone_number" class="form-label">{{ __('admin.common.phone_number') }}<span
                            class="text-danger"> *</span></label>
                    <input type="text" class="form-control edit_driver_phone_number" name="phone_number"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_email" class="form-label">{{ __('admin.common.email') }}<span class="text-danger">
                            *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_address" class="form-label">{{ __('admin.common.address') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="edit_assigned_cars" class="form-label">{{ __('admin.manage.assigned_vehicles') }}<span
                            class="text-danger"> *</span></label>
                    <select class="select select2" id="edit_assigned_cars" name="assigned_cars[]"
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="edit_card_number" class="form-label">{{ __('admin.manage.card_number') }}<span
                            class="text-danger"> *</span></label>
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="edit_date_of_issue" class="form-label">{{ __('admin.manage.date_of_issue') }}<span
                            class="text-danger"> *</span></label>
                    <input type="text" class="form-control date_of_issue" name="date_of_issue" id="edit_date_of_issue"
                        placeholder="dd-mm-yyyy">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="edit_valid_date" class="form-label">{{ __('admin.manage.valid_date') }}<span
                            class="text-danger"> *</span></label>
                    <input type="text" class="form-control valid_date" name="valid_date" id="edit_valid_date"
                        placeholder="dd-mm-yyyy">
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    <label for="edit_documents" class="form-label">{{ __('admin.common.documents') }}</label><span
                        class="text-danger"> *</span></label>
                    <div class="document-upload text-center br-3 mb-3">
                        ...
                        <p class="mb-2">{{ __('admin.common.drop_your_files_here_or') }} <span
                                class="text-info text-decoration-underline">{{ __('admin.common.browse') }}</span></p>
                        <p class="fs-12 mb-0">{{ __('admin.common.maximum_size', ['size' => 5]) }}</p>
                        <input type="file" class="form-control image-sign" name="documents[]" id="edit_documents"
                            multiple="">
                    </div>
        ...
        <div class="d-flex justify-content-between align-items-center w-100">
            <div class="form-check form-check-md form-switch me-2">
                <label for="status" class="form-check-label form-label mt-0 mb-0">
                    <input class="form-check-input form-label me-2 status" id="status" name="status" type="checkbox"
