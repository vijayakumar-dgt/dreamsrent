			...
			<div class="content me-4">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
					<div class="my-auto mb-2">
						<h2 class="mb-1">{{ __('admin.rentals.extra_services') }}</h2>
						<nav>
							<ol class="breadcrumb mb-0">
								<li class="breadcrumb-item">
									<a href="{{ route('dashboard') }}">{{ __('admin.common.home') }}</a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">{{ __('admin.rentals.extra_services') }}</li>
							</ol>
						</nav>
					</div>
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                        <div class="mb-2">
							...
							<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_extra_service" class="btn btn-primary d-flex align-items-center d-none real-label" id="add_new_extra_service"><i class="ti ti-plus me-2"></i>{{ __('admin.rentals.add_new_extra_service') }}</a>
                            @endif
						</div>
					</div>
				</div>
...
@endsection
@push('scripts')
<script src="{{ asset('backend/assets/js/carinfo/extra_services.js') }}"></script>
@endpush