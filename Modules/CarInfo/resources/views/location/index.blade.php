...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.manage.locations')" :breadcrumbs="[
                    __('admin.manage.locations') => ''
                ]" :buttonText="__('admin.manage.add_new_location')" :modalId="'add_location'"
            :buttonId="'add_new_location'" :permissionModule="'locations'" />
        <!-- Table Header -->
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                <div class="dropdown">
                    <button type="button" class="dropdown-toggle btn btn-white d-inline-flex align-items-center"
                        ...
                        <i class="ti ti-badge me-1"></i> <span class="statuslabel">
                            {{ __('admin.common.status') }}</span>
                    </button>
                    <ul class="dropdown-menu  dropdown-menu-end p-2">
                        <li>
                            <button type="button" class="dropdown-item rounded-1"
                                data-label="{{ __('admin.common.active') }}">{{ __('admin.common.active') }}</button>
                        </li>
                        <li>
                            <button type="button" class="dropdown-item rounded-1"
                                data-label="{{ __('admin.common.inactive') }}">{{ __('admin.common.inactive') }}</button>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <table class="table" id="locationTable">
                <thead class="thead-light">
                    <tr>
                        ...
                        @if (hasPermission($permissions, 'locations', 'edit') || hasPermission($permissions,
                        'locations', 'delete'))
...
<x-admin.modal className="addmodal" id="add_location" dialogClassName="modal-lg" modalBodyClass="custom-modal-body"
    :title="__('admin.manage.add_location')" action="{{  route('store_location') }}" formId="locationForm" method="POST"
    ...
    <x-slot name="body">
        ...
        <div class="mb-3">
            ...
            <div class="d-flex">
                <div
                    class="d-flex align-items-center justify-content-center avatar avatar-xxxl border border-dashed me-2 flex-shrink-0 text-dark">
                    <img src="{{ uploadedAsset('', 'default') }}" id="image_preview" class="img-fluid d-none"
                        alt="Location">
                ...
                <div class="d-flex align-items-center">
                    <div class="profile-upload">
                        ...
                        <div class="mt-2">
                            <p class="fs-14">
                                {{ __('admin.common.image_size_600_420', ['pixel' => '180*180', 'size' => 2]) }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-3">
            <label for="name" class="form-label">{{ __('admin.manage.location_title') }} <span
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <label for="email" class="form-label">{{ __('admin.common.email')}} <span
                        class="text-danger">*</span></label>
                <input type="text" class="form-control" name="email" id="email">
                <span id="email_error" class="text-danger error-text"></span>
            </div>
            <div class="col-md-6">
                <label for="mobile" class="form-label">{{ __('admin.common.phone')}} <span
                        class="text-danger">*</span></label>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <label for="address" class="form-label">{{ __('admin.common.address')}} <span
                        class="text-danger">*</span></label>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <label for="country" class="form-label">{{ __('admin.common.country')}} <span
                        class="text-danger">*</span></label>
            ...
            <div class="col-md-6">
                <label for="state" class="form-label">{{ __('admin.common.state')}} <span
                        class="text-danger">*</span></label>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <label for="city" class="form-label">{{ __('admin.common.city')}} <span
                        class="text-danger">*</span></label>
                <select name="city" id="city" class="form-control select2"></select>
                <span id="city_error" class="text-danger error-text"></span>
            </div>
            <div class="col-md-6">
                <label for="pincode" class="form-label">{{ __('admin.common.pincode')}} <span
                        class="text-danger">*</span></label>
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="form-check form-check-md form-switch me-3">
                    <input class="form-check-input working-day-checkbox" value="monday" type="checkbox" role="switch"
                        name="working_days[]" id="monday" aria-checked="false">
                    <label for="monday" class="form-check-label ms-2"
                        for="monday">{{ __('admin.manage.monday') }}</label>
                </div>
                <div class="d-flex align-items-center">
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="form-check form-check-md form-switch me-3">
                    <input class="form-check-input working-day-checkbox" value="tuesday" type="checkbox" role="switch"
                        name="working_days[]" id="tuesday" aria-checked="false">
                    <label for="tuesday" class="form-check-label ms-2"
                        for="tuesday">{{ __('admin.manage.tuesday') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <div class="position-relative">
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="form-check form-check-md form-switch me-3">
                    <input class="form-check-input working-day-checkbox" value="wednesday" type="checkbox" role="switch"
                        name="working_days[]" id="wednesday" aria-checked="false">
                    <label for="wednesday" class="form-check-label ms-2"
                        for="wednesday">{{ __('admin.manage.wednesday') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <div class="position-relative">
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="form-check form-check-md form-switch me-3">
                    <input class="form-check-input working-day-checkbox" value="thursday" type="checkbox" role="switch"
                        name="working_days[]" id="thursday" aria-checked="false">
                    <label for="thursday" class="form-check-label ms-2"
                        for="thursday">{{ __('admin.manage.thursday') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <div class="position-relative">
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="form-check form-check-md form-switch me-3">
                    <input class="form-check-input working-day-checkbox" value="friday" type="checkbox" role="switch"
                        name="working_days[]" id="friday" aria-checked="false">
                    <label for="friday" class="form-check-label ms-2"
                        for="friday">{{ __('admin.manage.friday') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <div class="position-relative">
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="form-check form-check-md form-switch me-3">
                    <input class="form-check-input working-day-checkbox" value="saturday" type="checkbox" role="switch"
                        name="working_days[]" id="saturday" aria-checked="false">
                    <label for="saturday" class="form-check-label ms-2"
                        for="saturday">{{ __('admin.manage.saturday') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <div class="position-relative">
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center justify-content-between">
                <div class="form-check form-check-md form-switch me-3">
                    <input class="form-check-input working-day-checkbox" value="sunday" type="checkbox" role="switch"
                        name="working_days[]" id="sunday" aria-checked="false">
                    <label for="sunday" class="form-check-label ms-2"
                        for="sunday">{{ __('admin.manage.sunday') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <div class="position-relative">
