...
<!-- Add/Edit Steering -->
<x-admin.modal className="addmodal" id="steering_type_modal" :title="__('admin.rentals.create_steering_type')"
    action="{{  route('steeringType.store') }}" formId="steeringTypeForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <div class="mb-3">
            <label for="steering_type" class="form-label">{{ __('admin.rentals.steering_type') }}<span
