...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.vehicle_models')" :breadcrumbs="[
					__('admin.rentals.vehicle_models') => ''
				]" :buttonText="__('admin.rentals.add_new_vehicle_model')" :modalId="'car_model_modal'" :buttonId="'add_car_model'"
...
<x-admin.modal className="addmodal" id="car_model_modal" :title="__('admin.rentals.create_vehicle_model')"
    action="{{  route('carModel.store') }}" formId="carModelForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <input type="hidden" name="language_id" id="language_id">
        <div class="mb-3">
            <label for="model_name" class="form-label">{{__('admin.rentals.model_name')}}<span class="text-danger">
                    *</span></label>
        ...
        <div class="mb-3">
            <label for="brand_id" class="form-label">{{__('admin.rentals.brand')}}<span class="text-danger">
                    *</span></label>
...
@push('scripts')
<script src="{{ asset('backend/assets/js/vehicleinfo/model.js') }}"></script>
@endpush
