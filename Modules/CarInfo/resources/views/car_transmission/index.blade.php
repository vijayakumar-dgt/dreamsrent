...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.vehicle_transmission')" :breadcrumbs="[
                    __('admin.rentals.vehicle_transmission') => ''
                ]" :buttonText="__('admin.rentals.add_new_vehicle_transmission')" :modalId="'car_transmission_modal'"
            :buttonId="'add_car_transmission'" :permissionModule="'vehicle_attributes'" />
        <!-- Table Header -->
...
<x-admin.modal className="addmodal" id="car_transmission_modal" :title="__('admin.rentals.create_vehicle_transmission')"
    action="{{  route('carTrasmission.store') }}" formId="carTransmissionForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <input type="hidden" name="language_id" id="language_id">
        <div class="mb-3">
            <label for="name" class="form-label">{{ __('admin.rentals.vehicle_transmission') }}<span
