	...
	<div class="content me-4">
		...
		<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
			<div class="my-auto mb-2">
				<h2 class="mb-1">{{ __('admin.rentals.vehicle_transmission') }}</h2>
				<nav>
					<ol class="breadcrumb mb-0">
						<li class="breadcrumb-item">
							<a href="{{ route('dashboard') }}">{{ __('admin.common.home') }}</a>
						</li>
						<li class="breadcrumb-item active" aria-current="page">{{ __('admin.rentals.vehicle_transmission') }}</li>
					</ol>
				</nav>
			</div>
			<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
				<div class="mb-2">
					...
					<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#car_transmission_modal" id="add_car_transmission" class="btn btn-primary d-flex align-items-center d-none real-label"><i class="ti ti-plus me-2"></i>{{ __('admin.rentals.add_new_vehicle_transmission') }}</a>
					@endif
				</div>
			</div>
		</div>
			...
			<div class="d-flex align-items-center flex-wrap row-gap-3 d-none real-label"> 
				<div class="top-search">
					<div class="top-search-group">
						...
						<input type="text" class="form-control" placeholder="{{ __('admin.common.search') }}" id="keyword" name="keyword">
					</div>
				</div>
			</div>
			<div class="skeleton label-skeleton label-loader"></div>
...
<!-- Add Brand -->
<div class="modal fade addmodal" id="car_transmission_modal">
	<div class="modal-dialog modal-dialog-centered modal-md">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="mb-0 modal-title">{{ __('admin.rentals.create_vehicle_transmission') }}</h4>
			...
			<form id="carTransmissionForm">
				...
				<div class="modal-body">                   
					<div class="mb-3">
						<label class="form-label">{{ __('admin.rentals.vehicle_transmission') }}<span class="text-danger"> *</span></label>
...
<div class="modal fade deletemodal" id="delete-modal">
	<div class="modal-dialog modal-dialog-centered modal-sm">
		<div class="modal-content">
			<form id="delateCarTransmissionForm">
				@csrf
				...
				<div class="modal-body text-center">
					...
					<h4 class="mb-1">{{ __('admin.rentals.delete_vehicle_transmission') }}</h4>
					<p class="mb-3">{{ __('admin.rentals.delete_vehicle_transmission_confirmation') }}</p>
					<div class="d-flex justify-content-center">
						<a href="javascript:void(0);" class="btn btn-light me-3" data-bs-dismiss="modal">{{ __('admin.common.cancel') }}</a>
...
@push('scripts')
<script src="{{ asset('assets/js/carinfo/car-transmission.js') }}"></script>
@endpush