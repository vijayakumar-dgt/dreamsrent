...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.maintenance')" :breadcrumbs="[
                    __('admin.rentals.maintenance') => ''
                ]" :buttonText="__('admin.rentals.add_new_maintenance')" :modalId="'maintenance_modal'"
            :buttonId="'add_maintenance'" :permissionModule="'maintenance'" />
        <!-- Table Header -->
                ...
                <div class="me-2">
                    <div class="input-icon-start position-relative topdatepicker">
                        ...
                        <input type="text" class="form-control date-range bookingrange" name="sort_by_date"
                            id="sort_by_date" placeholder="dd/mm/yyyy - dd/mm/yyyy">
                    </div>
                </div>
                <div class="dropdown">
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap row-gap-3">
                <div class="top-search">
                    <div class="top-search-group">
                        ...
                        <input type="text" class="form-control" name="overall_search" id="overall_search"
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg p-2" id="statusList">
                        <li>
                            <label class="dropdown-item d-flex align-items-center rounded-1">
                                <input class="form-check-input m-0 me-2 status_checkbox" type="checkbox"
                                    value="1">{{ __('admin.common.planned') }}
                            </label>
                        </li>
                        <li>
                            <label class="dropdown-item d-flex align-items-center rounded-1">
                                <input class="form-check-input m-0 me-2 status_checkbox" type="checkbox"
                                    value="2">{{ __('admin.common.in_progress') }}
                            </label>
                        </li>
                        <li>
                            <label class="dropdown-item d-flex align-items-center rounded-1">
                                <input class="form-check-input m-0 me-2 status_checkbox" type="checkbox"
                                    value="3">{{ __('admin.common.completed') }}
                            </label>
                        </li>
                    </ul>
                </div>
            ...
            <table class="table" id="maintenanceTable">
                <thead class="thead-light">
                    <tr>
                        ...
                        @if (hasPermission($permissions, 'maintenance', 'edit') || hasPermission($permissions,
                        'maintenance', 'delete'))
...
<x-admin.modal className="addmodal" id="maintenance_modal" :title="__('admin.rentals.create_maintenance')"
    action="{{  route('maintenance.store') }}" formId="maintenanceForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <div class="row">
            <div class="col-md-6">
                <label for="vehicle_id" class="form-label">{{ __('admin.common.vehicle') }}<span class="text-danger">
                        *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="odometer" class="form-label">{{ __('admin.common.odometer') }}<span class="text-danger">
                            *</span></label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="start_date" class="form-label">{{ __('admin.common.start_date') }}<span
                            class="text-danger"> *</span></label>
                    <input type="text" class="form-control custom_date_picker" name="start_date" id="start_date"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="end_date" class="form-label">{{ __('admin.common.end_date') }}<span class="text-danger">
                            *</span></label>
                    <input type="text" class="form-control custom_date_picker" name="end_date" id="end_date"
                        placeholder="dd-mm-yyyy">
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    <label for="details" class="form-label">{{ __('admin.common.details') }}<span class="text-danger">
                            *</span></label>
            ...
            <div class="col-md-12">
                <label for="status" class="form-label">{{ __('admin.common.status') }}<span class="text-danger">
                        *</span></label>
