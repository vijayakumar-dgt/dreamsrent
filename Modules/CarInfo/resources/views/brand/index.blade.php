...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.brands')" :breadcrumbs="[
                        __('admin.rentals.brands') => ''
                    ]" :buttonText="__('admin.rentals.add_new_brand')" :modalId="'brand_modal'" :buttonId="'add_brand'"
            ...
            <table class="table" id="brandTable">
                <thead class="thead-light">
                    <tr>
                        ...
                        @if (hasPermission($permissions, 'vehicle_attributes', 'edit') || hasPermission($permissions,
                        'vehicle_attributes', 'delete'))
...
<!-- Add/Edit Brand -->
<x-admin.modal className="addmodal" id="brand_modal" :title="__('admin.rentals.create_brand')"
    action="{{  route('brand.store') }}" formId="brandForm" method="POST" enctype="multipart/form-data">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <input type="hidden" name="language_id" id="language_id">
        <div class="col-md-12">
            <div class="mb-3">
                <label for="vehicle_category_id" class="form-label">{{ __('admin.rentals.category') }} <span
        ...
        <div class="mb-3">
            <label for="brand_image" class="form-label">{{ __('admin.rentals.brand_image') }}<span class="text-danger">
                    *</span></label>
            <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                <div
                    class="d-flex align-items-center justify-content-center avatar avatar-xxl border me-3 flex-shrink-0 text-dark">
                    <img src="{{ uploadedAsset('', 'default') }}" id="imagePreview" class="img-fluid d-none"
                        alt="Brand">
        ...
        <div class="mb-3">
            <label for="brand_icon" class="form-label">{{ __('admin.rentals.brand_icon') }}<span class="text-danger">
                    *</span></label>
            <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                <div
                    class="d-flex align-items-center justify-content-center avatar avatar-xxl border me-3 flex-shrink-0 text-dark">
                    <img src="{{ uploadedAsset('', 'default') }}" id="iconPreview" class="img-fluid d-none"
                        alt="Brand Icon">
        ...
        <div class="mb-3">
            <label for="brand_name" class="form-label">{{ __('admin.rentals.brand_name') }}<span class="text-danger">
                    *</span></label>
