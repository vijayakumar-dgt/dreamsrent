...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.vehicle_colors')" :breadcrumbs="[
                    __('admin.rentals.vehicle_colors') => ''
                ]" :buttonText="__('admin.rentals.add_new_vehicle_color')" :modalId="'car_color_modal'" :buttonId="'add_car_color'"
...
<x-admin.modal className="addmodal" id="car_color_modal" :title="__('admin.rentals.create_vehicle_color')"
    formId="carColorForm">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <input type="hidden" name="language_id" id="language_id">
        <div class="mb-3">
            <label for="name" class="form-label">{{ __('admin.rentals.color_name') }}<span class="text-danger">
                    *</span></label>
            <input type="text" class="form-control" name="name" id="name" maxlength="50">
            <span id="name_error" class="text-danger error-text"></span>
        </div>
        <div class="mb-3">
            <label for="value" class="form-label">{{ __('admin.rentals.color_code') }}<span class="text-danger">
                    *</span></label>
            <input type="color" class="form-control border rounded-0 w-100" name="value" id="value" value="#000000"
