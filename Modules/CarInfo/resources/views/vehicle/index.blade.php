...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.all_vehicle')" :breadcrumbs="[
            ...
            <div class="d-flex align-items-center flex-wrap row-gap-3">
                ...
                <div class="me-2">
                    <div class="input-icon-start position-relative topdatepicker">
                        ...
                        <input type="text" name="sort_by_date" id="sort_by_date"
                            class="form-control date-range bookingrange" placeholder="dd/mm/yyyy - dd/mm/yyyy">
                    </div>
                </div>
                <div class="dropdown">
                ...
                <div class="top-search me-2">
                    <div class="top-search-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="{{ __('admin.rentals.search') }}">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="custom-scroll">
                            ...
                            <li>
                                <label class="dropdown-item d-flex align-items-center rounded-1">
                                    <input class="form-check-input m-0 me-2" type="checkbox" id="vehicle_id"
                                        name="vehicle_id" value="{{ $value->id }}">{{ $value->name }}
                                </label>
                            </li>
                            @endforeach
                        </div>
                ...
                <div class="dropdown me-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg p-2">
                        ...
                        <div class="custom-scroll">
                            ...
                            <li>
                                <label class="dropdown-item d-flex align-items-center rounded-1">
                                    <input class="form-check-input m-0 me-2" type="checkbox" id="vehicle_type_id"
                                        name="vehicle_type_id" value="{{ $value->id }}">{{ $value->name }}
                                </label>
                            </li>
                            @endforeach
                        </div>
                ...
                <div class="dropdown me-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg p-2">
                        ...
                        <div class="custom-scroll">
                            ...
                            <li>
                                <label class="dropdown-item d-flex align-items-center rounded-1">
                                    <input class="form-check-input m-0 me-2" type="checkbox" id="vehicle_location_id"
                                        name="vehicle_location_id" value="{{ $value->id }}">{{ $value->name }}
                                </label>
                            </li>
                            @endforeach
                        </div>
...
<!-- Status Modal-->
<x-admin.modal className="addmodal" id="status-modal" dialogClassName="modal-sm" isHeader="{{ false }}"
    modalBodyClass="text-center" action="{{  route('admin.setStatus') }}" formId="statusVehicleForm" method="POST">
    <x-slot name="body">
