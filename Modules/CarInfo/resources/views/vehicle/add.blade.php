...
@section('meta_title', __('admin.rentals.add_vehicle') . ' || ' . $companyName)
                ...
                <div class="add-wizard car-steps">
                        ...
                        <form id="carBasicInfoForm" autocomplete="off">
                            ...
                            <div
                                ...
                                <div class="dropdown flag-dropdown">
                                    <button type="button"
                                        class="dropdown-toggle btn btn-white d-flex align-items-center justify-content-between py-1 px-2"
                                        ...
                                        <li>
                                            <button type="button"
                                                ...
                                                <img src="{{ asset('backend/assets/img/flags/' . $language->code . '.svg') }}"
                                                    alt="Language" class="rounded-circle me-2 lang-flag">
                                                {{ $language->name }}
                                            </button>
                                        </li>
                                        @endforeach
                                    ...
                                    <div class="col-xl-9">
                                        <div class="d-flex align-items-center flex-wrap row-gap-3 upload-pic">
                                            <div
                                                ...
                                                <img src="{{ asset('/backend/assets/img/car/default-car.png') }}"
                            ...
                            <div class="border-bottom mb-2 pb-2">
                                <div class="row row-gap-4">
                                    ...
                                    <div class="col-xl-8">
                                        <div class="mb-3">
                                            <label class="form-label" for="title">{{ __('admin.rentals.name') }} <span
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label"
                                                for="perma_link">{{ __('admin.rentals.permalink') }}</label>
                                            <input type="text" class="form-control" name="perma_link" id="perma_link"
                                                placeholder="https://www.example.com/vehicle/" maxlength="100">
                                            <p class="fs-13 fw-medium mt-1 mb-0">{{ __('admin.rentals.preview') }} : <a
                                                    href="#" class="link-info">https://www.example.com/vehicle/</a></p>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="vehicle_category_id">{{ __('admin.rentals.category') }}
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <label class="form-label"
                                                            for="vehicle_type_id">{{ __('admin.rentals.vehicle_type') }}
                                                            <span class="text-danger">*</span></label>
                                                    </div>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <label class="form-label"
                                                            for="vehicle_brand_id">{{ __('admin.rentals.brand') }} <span
                                                                class="text-danger">*</span></label>
                                                    </div>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <label class="form-label"
                                                            for="vehicle_model_id">{{ __('admin.rentals.model') }} <span
                                                                class="text-danger">*</span></label>
                                                    </div>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="plate_number">{{ __('admin.rentals.plate_number') }}</label>
                                                    <input type="text" name="plate_number" maxlength="10"
                                                        placeholder="{{ __('admin.rentals.plate_number_placeholder') }}"
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="vin_number">{{ __('admin.rentals.vin_number') }}</label>
                                                    <input type="text" name="vin_number" id="vin_number" maxlength="10"
                                                        placeholder="{{ __('admin.rentals.vin_number_placeholder') }}"
                                                        class="form-control">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="main_location_id">{{ __('admin.rentals.main_location') }}
                                                        <span class="text-danger">*</span></label>
                                                    <select name="main_location_id" class="form-control select"
                                                        ...
                                                        <option value="{{ $LocationValues->id }}">
                                                            {{ ucwords(strtolower($LocationValues->name )) }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="other_location_id">{{ __('admin.rentals.link_other_location') }}</label>
                                                    <select name="other_location_id[]" id="other_location_id"
                                                        placeholder="Select" class="form-control select" multiple>
                                                        <option value="">{{ __('admin.rentals.select') }}</option>
                                                        @foreach($Location as $LocationValues)
                                                        <option value="{{ $LocationValues->id }}">
                                                            {{ $LocationValues->name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="vehicle_fuel_id">{{ __('admin.rentals.fuel') }}</label>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="odometer">{{ __('admin.rentals.odometer') }}</label>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="vehicle_color_id">{{ __('admin.rentals.color') }} <span
                                                            class="text-danger">*</span></label>
                                                    <select name="vehicle_color_id"
                                                        ...
                                                        <option value="{{ $CarColorValues->id }}"
                                                            data-color="{{ $CarColorValues->value }}">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="vehicle_year">{{ __('admin.rentals.year') }} <span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-icon-end position-relative">
                                                        <input type="text" name="vehicle_year"
                                                            placeholder="{{ __('admin.rentals.year_placeholder') }}"
                                                            id="vehicle_year" class="form-control yearpickerVehicle">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="vehicle_transmission_id">{{ __('admin.rentals.transmission') }}</label>
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="vehicle_mileage">{{ __('admin.rentals.mileage') }}</label>
                                                    <input name="vehicle_mileage" id="vehicle_mileage" maxlength="2"
                                                        placeholder="{{ __('admin.rentals.mileage_placeholder') }}"
                                                        type="text" class="form-control priceLimit">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="vehicle_passenger">{{ __('admin.rentals.passengers') }}
                                                        <span class="text-danger">*</span></label></label>
                                                    <input name="vehicle_passenger" id="vehicle_passenger" maxlength="2"
                                                        placeholder="{{ __('admin.rentals.passengers_placeholder') }}"
                                                        type="text" class="form-control priceLimit">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-6 CarContain">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="num_seats">{{ __('admin.rentals.no_of_seats') }}</label>
                                                    <select name="num_seats" class="form-control select" id="num_seats">
                                                        <option value="">{{ __('admin.rentals.select') }}</option>
                                                        @for ($i = 2; $i <= 14; $i++) <option value="{{ $i }}">{{ $i }}
                                                            </option>
                                                            @endfor
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-6 CarContain car-doors-field">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="num_doors">{{ __('admin.rentals.no_of_doors') }}</label>
                                                    <select name="num_doors" class="form-control select" id="num_doors">
                                                        <option value="">{{ __('admin.rentals.select') }}</option>
                                                        @for ($i = 2; $i <= 10; $i++) <option value="{{ $i }}">{{ $i }}
                                                            </option>
                                                            @endfor
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-6 CarContain">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="num_airbags">{{ __('admin.rentals.no_of_airbags') }}</label>
                                                    <input type="text" class="form-control priceLimit" maxlength="1"
                                                        placeholder="{{ __('admin.rentals.airbags_placeholder') }}"
                                            ...
                                            <div class="col-lg-4 col-md-6 BoatContain">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="water_tight">{{ __('admin.rentals.water_tight') }}</label>
                                                    <select name="water_tight" class="form-control select"
                                                        id="water_tight">
                                                        <option value="">{{ __('admin.rentals.select') }}</option>
                                                        @for ($i = 1; $i <= 20; $i++) <option value="{{ $i }}">{{ $i }}
                                                            </option>
                                                            @endfor
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-6 BoatContain">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="sliding">{{ __('admin.rentals.sliding') }}</label>
                                            ...
                                            <div class="col-lg-4 col-md-6 BoatContain">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="hatch">{{ __('admin.rentals.hatch') }}</label>
                                            ...
                                            <div class="col-lg-12 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="description">{{ __('admin.rentals.description') }}</label>
                                                    <textarea type="text" class="form-control summernote"
                                                        maxlength="500"
                                                        placeholder="{{ __('admin.rentals.description_placeholder') }}"
                        ...
                        <form id="featuresForm">
                                            ...
                                            <div class="col-lg-4 col-md-6 cursor-pointer">
                                                <div class="mb-3 position-relative vechicle-add">
                                                    <div class="form-check form-checkbox mb-0">
                                                        <input class="form-check-input singleCheckbox"
                                                            name="feature_id[]" type="checkbox"
                                                            id="amenity_{{ $SafetyFeatureValues->id }}"
                                                            value="{{ $SafetyFeatureValues->id }}">
                                                    </div>
                                                    <label class="form-check-label"
                                                        for="amenity_{{ $SafetyFeatureValues->id }}">
                            ...
                            <div class="d-flex align-items-center justify-content-end pt-3">
                                ...
                                <button id="priceTariffNext" type="button"
                                    class="btn btn-primary d-flex align-items-center">{{ __('admin.rentals.add_tariff_pricing') }}<i
                                        class="ti ti-chevron-right ms-1"></i></button>
                            </div>
                        </form>
                    </fieldset>
                                    ...
                                    <div class="col-xl-9">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="daily">{{ __('admin.rentals.pricing_type') }} <span
                                                            class="text-danger">*</span></label>
                                                    <div class="d-flex align-items-center flex-wrap gap-3">
                                                        ...
                                                        <div class="form-check mb-0">
                                                            <input class="form-check-input price-checkbox"
                                                                type="checkbox" name="montly" id="montly">
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="daily_price">{{ __('admin.rentals.daily_price') }} <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="weekly_price">{{ __('admin.rentals.weekly_price') }} <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control price-input priceLimit"
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="montly_price">{{ __('admin.rentals.monthly_price') }} <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control price-input priceLimit"
                                                        name="montly_price" id="montly_price"
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="yearly_price">{{ __('admin.rentals.yearly_price') }} <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control price-input priceLimit"
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <label class="form-label"
                                                            for="Baseunlimited">{{ __('admin.rentals.base_kilometers_per_day') }}
                                                            <span class="text-danger">*</span></label>
                                                        <div class="form-check mb-2">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="unlimited" id="Baseunlimited">
                                                    ...
                                                    <input type="text" name="basic_kilometer" id="basic_kilometer"
                                                        maxlength="8"
                                                        placeholder="{{ __('admin.rentals.enter_base_kilometers') }}"
                                                        class="form-control priceLimit">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="extra_kilometer">{{ __('admin.rentals.extra_kilometers_price') }}
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" name="extra_kilometer" id="extra_kilometer"
                                                        maxlength="8"
                                                        placeholder="{{ __('admin.rentals.enter_extra_kilometers_price') }}"
                                                        class="form-control priceLimit">
                                                </div>
                    ...
                    <fieldset id="forth-field">
                        <form id="extraServiceForm">
                            <div
                                class="filterbox  p-20 mb-4 p-20 mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                                <h4 class="d-flex align-items-center"><i
                                    ...
                                    <div class="col-xl-9">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    <label class="form-label"
                                                        for="platform">{{ __('admin.rentals.platform') }} <span
                                                            class="text-danger"></span></label>
    ...
    <x-slot name="body">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <label for="unlimited1" class="form-label">{{ __('admin.rentals.base_km_per_day') }} <span
                                class="text-danger">*</span></label>
                        <div class="form-check mb-2">
    ...
    <x-slot name="body">
        ...
        <div class="mb-3">
            ...
            <select class="form-control custom-select" name="dam_type" id="dam_type">
                ...
                <option value="{{ $DamageTypesValue->id }}" class="{{ $DamageTypesValue->id }}">
                    {{ $DamageTypesValue->damage_type }}</option>
                @endforeach
            </select>
        </div>
        <div class="mb-3">
