                        ...
                        <form id="carBasicInfoForm" autocomplete="off">
                            ...
                            <div class="border-bottom mb-2 pb-2">
                                <div class="row row-gap-4">
                                    ...
                                    <div class="col-xl-8">
                                        <div class="mb-3">
                                            <label class="form-label" for="title">{{ __('admin.common.name') }} <span
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="vehicle_passenger">{{ __('admin.dashboard.passengers') }}
                                            ...
                                            <div class="col-lg-12 col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="description">{{ __('admin.common.description') }}</label>
