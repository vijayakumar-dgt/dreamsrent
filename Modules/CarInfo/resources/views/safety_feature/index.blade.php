...
@section('meta_title',  __('admin.rentals.safety_features') . ' || ' . $companyName)
...
@section('content')
		...
		<div class="content me-4">		
			...
			<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
				<div class="my-auto mb-2">
					<h2 class="mb-1">{{ __('admin.rentals.safety_features') }}</h2>
					<nav>
						<ol class="breadcrumb mb-0">
							<li class="breadcrumb-item">
								<a href="{{ route('dashboard') }}">{{ __('admin.common.home') }}</a>
							</li>
							<li class="breadcrumb-item active" aria-current="page">{{ __('admin.rentals.safety_features') }}</li>
						</ol>
					</nav>
				</div>
				<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
					...
					<div class="mb-2">
						...
						<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#safety_feature_modal" id="add_safety_feature" class="btn btn-primary d-flex align-items-center d-none real-label"><i class="ti ti-plus me-2"></i>{{ __('admin.rentals.add_new_safety_feature') }}</a>
					@endif
					</div>
				</div>
			</div>
			...
			<div class="custom-datatable-filter table-responsive brandstable d-none real-table">
				<table class="table" id="safetyFeatureTable">
					<thead class="thead-light">
						<tr>
							<th>{{ strtoupper(__('admin.rentals.feature')) }}</th>
	...
	<div class="modal fade addmodal" id="safety_feature_modal">
		<div class="modal-dialog modal-dialog-centered modal-md">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="mb-0 modal-title">{{ __('admin.rentals.create_safety_feature') }}</h4>
					<button type="button" class="btn-close custom-btn-close" data-bs-dismiss="modal" aria-label="Close">
						<i class="ti ti-x fs-16"></i>
					</button>
				</div>
				<form id="safetyFeatureForm" autocomplete="off">
					@csrf
	...
	<div class="modal fade deletemodal" id="delete-modal">
		<div class="modal-dialog modal-dialog-centered modal-sm">
			<div class="modal-content">
				<form id="deleteSafetyFeatureForm">
					@csrf
					...
					<div class="modal-body text-center">
						...
						<h4 class="mb-1">{{ __('admin.rentals.delete_safety_feature') }}</h4>
						<p class="mb-3">{{ __('admin.rentals.delete_safety_feature_confirmation') }}</p>
						<div class="d-flex justify-content-center">
							<a href="javascript:void(0);" class="btn btn-light me-3" data-bs-dismiss="modal">{{ __('admin.common.cancel') }}</a>
