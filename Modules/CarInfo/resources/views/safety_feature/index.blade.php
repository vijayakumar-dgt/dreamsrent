...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.safety_features')" :breadcrumbs="[
                    __('admin.rentals.safety_features') => ''
                ]" :buttonText="__('admin.rentals.add_new_safety_feature')" :modalId="'safety_feature_modal'"
            :buttonId="'add_safety_feature'" :permissionModule="'vehicle_attributes'" />
        <!-- Table Header -->
...
<x-admin.modal className="addmodal" id="safety_feature_modal" :title="__('admin.rentals.create_safety_feature')"
    action="{{  route('safetyFeature.store') }}" formId="safetyFeatureForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <input type="hidden" name="language_id" id="language_id">
        <div class="mb-3">
            <label for="feature" class="form-label">{{ __('admin.rentals.feature') }}<span class="text-danger">
                    *</span></label>
