...
@section('meta_title',  __('admin.common.category') . ' || ' . $companyName)
...
@section('content')
		...
		<div class="content me-4">
			...
			<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
				<div class="my-auto mb-2">
					<h2 class="mb-1">{{ __('admin.rentals.category') }}</h2>
					<nav>
						<ol class="breadcrumb mb-0">
							<li class="breadcrumb-item">
								<a href="{{ route('dashboard') }}">{{ __('admin.common.home') }}</a>
							</li>
							<li class="breadcrumb-item active" aria-current="page">{{ __('admin.rentals.category') }}</li>
						</ol>
					</nav>
				</div>
				<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
					<div class="mb-2">
						...
						<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#category_modal" id="add_category" class="btn btn-primary d-flex align-items-center"><i class="ti ti-plus me-2"></i>{{ __('admin.rentals.add_new_category') }}</a>
						@endif
					</div>
				</div>
			</div>
	...
	<!-- Add Category -->
	<div class="modal fade addmodal" id="category_modal">
		<div class="modal-dialog modal-dialog-centered modal-md">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="mb-0 modal-title">{{ __('admin.rentals.create_category') }}</h4>
			...
			<div class="modal-content">
				<form id="delateCategory">
					...
					<div class="modal-body text-center">
						...
						<h4 class="mb-1">{{ __('admin.rentals.delete_category') }}</h4>
						<p class="mb-3">{{ __('admin.rentals.delete_category_confirmation') }}</p>
						<div class="d-flex justify-content-center">
							<a href="javascript:void(0);" class="btn btn-light me-3" data-bs-dismiss="modal">{{ __('admin.common.cancel') }}</a>
...
@push('scripts')
<script src="{{ asset('backend/assets/js/vehicleinfo/category.js') }}"></script>
@endpush