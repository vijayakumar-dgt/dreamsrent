...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.category')" :breadcrumbs="[
                    __('admin.rentals.category') => ''
                ]" :buttonText="__('admin.rentals.add_new_category')" :modalId="'category_modal'" :buttonId="'add_category'"
...
<!-- Add/Edit Category -->
<x-admin.modal className="addmodal" id="category_modal" :title="__('admin.rentals.create_category')"
    action="{{  route('category.store') }}" formId="categoryForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <input type="hidden" name="language_id" id="language_id">
        <div class="mb-3">
            <label for="name" class="form-label">{{ __('admin.common.category') }}<span class="text-danger">
                    *</span></label>
