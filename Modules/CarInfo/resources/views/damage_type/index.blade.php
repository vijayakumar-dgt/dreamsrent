...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.damage_types')" :breadcrumbs="[
                    __('admin.rentals.damage_types') => ''
                ]" :buttonText="__('admin.rentals.add_new_damage_type')" :modalId="'add_damage_type'"
            :buttonId="'add_new_damage_type'" :permissionModule="'vehicle_attributes'" />
        <!-- Table Header -->
...
<x-admin.modal className="addmodal" id="add_damage_type" :title="__('admin.rentals.create_damage_type')"
    action="{{  route('store_damage_type') }}" formId="damageTypeForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <input type="hidden" name="language_id" id="language_id">
        <div class="mb-3">
            <label for="damage_type" class="form-label">{{ __('admin.rentals.damage_type') }} <span
