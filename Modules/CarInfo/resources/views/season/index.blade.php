...
@section('content')
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">                        
                    <div class="mb-2">
                        ...
                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_season" class="btn btn-primary d-flex align-items-center d-none real-label" id="add_new_season"><i class="ti ti-plus me-2"></i>{{ __('admin.rentals.add_new_season') }}</a>
                    @endif
                    </div>
                </div>
            </div>
   ...
   <!-- /Page Wrapper -->
    ...
    <div class="modal fade addmodal" id="add_season">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title mb-0">{{ __('admin.rentals.create_season') }}</h4>
                    <button type="button" class="btn-close custom-btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="ti ti-x fs-16"></i>
                    </button>
                </div>
                <form action="" id="seasonForm">
                    @csrf
            ...
            <div class="modal-content">
                <form action="" id="deleteSeason">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="javascript:void(0);" class="btn btn-light me-3" data-bs-dismiss="modal">{{ __('admin.common.cancel') }}</a>
                            <button type="submit" class="btn btn-primary submitbtn">{{ __('admin.common.delete') }}</button>
                        </div>
                    </div>
                </form>
            </div>
