...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.seat_types')" :breadcrumbs="[
                    __('admin.rentals.seat_types') => ''
                ]" :buttonText="__('admin.rentals.add_new_seat_type')" :modalId="'seat_type_modal'" :buttonId="'add_seat_type'"
...
<!-- Add/Edit Seat -->
<x-admin.modal className="addmodal" id="seat_type_modal" :title="__('admin.rentals.create_seat_type')"
    action="{{  route('carSeat.store') }}" formId="seatTypeForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <div class="mb-3">
            <label for="seat_type" class="form-label">{{ __('admin.rentals.seat_type') }}<span class="text-danger">
                    *</span></label>
