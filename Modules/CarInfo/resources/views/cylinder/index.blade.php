				...
				<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
					...
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap">                        
						<div class="mb-2">
							...
							<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_cylinder" class="btn btn-primary d-none real-label d-flex align-items-center" id="add_new_cylinder"><i class="ti ti-plus me-2"></i>{{ __('admin.rentals.add_new_cylinder') }}</a>
						@endif
                        </div>
					</div>
				</div>
