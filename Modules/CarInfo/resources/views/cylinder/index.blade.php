...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.rentals.cylinders')" :breadcrumbs="[
                    __('admin.rentals.cylinders') => ''
                ]" :buttonText="__('admin.rentals.add_new_cylinder')" :modalId="'add_cylinder'" :buttonId="'add_new_cylinder'"
...
<x-admin.modal className="addmodal" id="add_cylinder" :title="__('admin.rentals.create_cylinder_type')"
    action="{{  route('store_cylinder_type') }}" formId="cylinderForm" method="POST">
    <x-slot name="body">
        <input type="hidden" name="id" id="id">
        <div class="mb-3">
            <label for="cylinder_type" class="form-label">{{ __('admin.rentals.cylinder_type') }} <span
