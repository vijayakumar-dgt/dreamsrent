                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
                    <div class="mb-2">
                        @if (hasPermission($permissions, 'vehicle_attributes', 'create'))
                            ...
                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_cylinder" class="btn btn-primary d-none real-label d-flex align-items-center" id="add_new_cylinder">
