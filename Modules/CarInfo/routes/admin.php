...
if (! function_exists('registerVehicleRoutes')) {
    function registerVehicleRoutes(): void
    {
        ...
        Route::get('get-seasonal-info', [VehicleInfoController::class, 'seasonalInfo'])->name('seasonalInfo');
        Route::get('get-tarrif-info', [VehicleInfoController::class, 'tarrifInfo'])->name('tarrifInfo');
        Route::get('get-documents-info', [VehicleInfoController::class, 'documents'])->name('documents');
        Route::get('get-faq-info', [VehicleInfoController::class, 'faq'])->name('faq');
        Route::get('get-damage-info', [VehicleInfoController::class, 'damage'])->name('damage');
        Route::get('get-insurance-info', [VehicleInfoController::class, 'insurance'])->name('insurance');
        Route::get('get-model', [VehicleInfoController::class, 'getModel']);
        Route::get('get-type-brand', [VehicleInfoController::class, 'getTypeAndModel']);
        Route::post('vehicle/image/delete', [VehicleInfoController::class, 'deleteVehicleImage']);
        Route::post('vehicle/policy/delete', [VehicleInfoController::class, 'deleteVehiclePolicy']);
        ...
        Route::get('/get-damage-details', [VehicleInfoController::class, 'getDamageDetails']);
