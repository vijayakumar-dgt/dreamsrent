...
<div class="page-wrapper">
    <div class="content me-4">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            ...
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                ...
                <div class="mb-2 me-2">
                    ...
                    <a href="javascript:void(0);" class="btn btn-primary d-flex align-items-center d-none real-label" data-bs-toggle="modal" data-bs-target="#add_menu"><i class="ti ti-plus me-2"></i>{{ __('admin.cms.add_new_menu') }}</a>
                </div>
                @endif
            </div>
        </div>
        ...
        <!-- Real Menu Table (hidden initially) -->
        ...
        <div class="modal-content">
            <form id="deleteMenu">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="mb-3">{{ __('admin.cms.delete_menu_confirmation') }}</p>
                    <div class="d-flex justify-content-center">
                        <a href="javascript:void(0);" class="btn btn-light me-3" data-bs-dismiss="modal">{{ __('admin.common.cancel') }}</a>
