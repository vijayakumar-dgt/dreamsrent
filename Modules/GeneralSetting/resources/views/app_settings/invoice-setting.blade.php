                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                                            <div
                                                ...
                                                <img id="profile_photo_preview" src="{{ uploadedAsset('', 'default2')}}"
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-4 col-sm-12">
                                    <label for="show_company_details"
                                        class="form-label">{{ __('admin.general_settings.show_company_details') }} <span
                                            class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="">
                                        <div class="form-check form-check-md form-switch">
                                            <input class="form-check-input" type="checkbox" id="show_company_details"
                                                name="show_company_details" role="switch" checked aria-checked="true">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="">
                                        <div class="mt-3">
                                            <textarea class="form-control" id="invoice_terms" name="invoice_terms"
                                                rows="3" placeholder="Enter invoice terms here..."></textarea>
