                    ...
                    <form id="companySettingForm" enctype="multipart/form-data">
                        ...
                        <div class="card-body d-none real-card">
                            ...
                            <div class="localization-content mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="company_profile_photo"
                                        class="form-label">{{ __('admin.general_settings.profile_photo') }}</label>
                                    <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                                        <div
                                            class="d-flex align-items-center justify-content-center avatar avatar-xxl me-3 flex-shrink-0 text-dark frames">
                                            <img src="{{ uploadedAsset('', 'default') }}" id="profile_photo_preview"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="owner_name"
                                                class="form-label">{{ __('admin.general_settings.owner_name') }} <span
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="company_email"
                                                class="form-label ">{{ __('admin.general_settings.email_address') }}
                                                <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="company_phone"
                                                class="form-label">{{ __('admin.common.phone_number') }} <span
                                                    class="text-danger">*</span></label>
                                            <div class="">
                                                <input type="text" class="form-control company_phone" id="company_phone"
                                                    name="company_phone">
                            ...
                            <div class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="company_address_line"
                                                class="form-label">{{ __('admin.general_settings.address_line') }}</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="country" class="form-label">{{ __('admin.common.country') }}
                                            </label>
                                            <div class="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="state" class="form-label">{{ __('admin.common.state') }}
                                            </label>
                                            <div class="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="company_postal_code"
                                                class="form-label">{{ __('admin.common.postal_code') }}</label>
                        ...
                        <div class="card-footer d-none real-card">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <button type="submit"
                                    class="btn btn-primary companysave">{{ __('admin.general_settings.save_changes') }}</button>
                                @endif
                            </div>
                        </div>
                    </form>
