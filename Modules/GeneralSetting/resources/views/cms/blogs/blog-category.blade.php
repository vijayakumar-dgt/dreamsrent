    ...
    <div class="content me-4">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div class="my-auto mb-2">
                <h4 class="mb-1">{{__('admin.blog.blog_categories')}}</h4>
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item">
                            <a href="/admin">{{__('admin.blog.home')}}</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('admin.blog.blog_categories')}}</li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                <div class="mb-2">
                    ...
                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_Category" class="btn btn-primary d-flex align-items-center"><i class="ti ti-plus me-2"></i>{{__('admin.blog.add_category')}}</a>
                    @endif
                </div>
            </div>
        </div>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-2">
                                    ...
                                    <li>
                                        <a class="dropdown-item rounded-1 open-edit-modal"
                                            ...
                                            <i class="ti ti-edit me-1"></i>{{__('admin.blog.edit')}}</a>
                                    </li>
                                    @endif
    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="mb-0">{{__('admin.blog.add_category')}}</h5>
...
<div class="modal fade" id="edit_Category">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="mb-0">{{__('admin.blog.edit_category')}}</h4>
                <button type="button" class="btn-close custom-btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="ti ti-x fs-16"></i>
                </button>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <h4 class="mb-1">{{__('admin.blog.delete_category')}}</h4>
                <p>{{__('admin.blog.are_you_sure_you_want_to_delete_this_category')}}?</p>
                <button class="btn btn-light" data-bs-dismiss="modal">{{__('admin.blog.cancel')}}</button>
                <button class="btn btn-danger" id="delete_category_btn">{{__('admin.blog.yes_delete')}}</button>
            </div>
        </div>
    </div>
</div>
