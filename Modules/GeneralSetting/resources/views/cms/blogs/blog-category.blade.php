            ...
            <div class="d-flex align-items-center flex-wrap row-gap-3">
                <div class="dropdown me-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-2">
                        <li><button type="button" class="dropdown-item rounded-1 sort-option-category" data-sort="latest">{{__('admin.common.latest')}}</button></li>
                        <li><button type="button" class="dropdown-item rounded-1 sort-option-category" data-sort="asc">{{__('admin.common.ascending')}}</button></li>
                        <li><button type="button" class="dropdown-item rounded-1 sort-option-category" data-sort="desc">{{__('admin.common.descending')}}</button></li>
                        <li><button type="button" class="dropdown-item rounded-1 sort-option-category" data-sort="last_month">{{__('admin.common.last_month')}}</button></li>
                        <li><button type="button" class="dropdown-item rounded-1 sort-option-category" data-sort="last_7_days">{{__('admin.common.last_7_days')}}</button></li>
                    </ul>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr data-created="{{ $category->created_at }}" data-name="{{ strtolower($category->name) }}">
                        ...
                        <td>
                            ...
                            <span class="badge badge-md badge-soft-success"><i class="ti ti-point-filled"></i>{{__('admin.cms.published')}}</span>
                            @endif
...
<x-admin.modal className="addmodal" id="add_Category" :title="__('admin.blog.add_category')">
    ...
    <x-slot name="footer">
        <div class="d-flex justify-content-center">
            ...
            <button type="submit" id="create_category_btn" class="btn btn-primary">{{__('admin.common.create_new')}}</button>
        </div>
    </x-slot>
</x-admin.modal>
<!-- /Add Category -->
