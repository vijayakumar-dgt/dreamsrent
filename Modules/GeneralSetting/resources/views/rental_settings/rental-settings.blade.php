                                    ...
                                    <div class="localization-content mb-3">
                                        <div>
                                            ...
                                            <div class="localization-list">
                                                ...
                                                <div>
                                                    <div class="form-check form-check-md form-switch">
                                                        <input id="booking" name="booking" class="form-check-input form-label" type="checkbox" role="switch" checked aria-checked="true">
                                                    </div>
                                            ...
                                            <div class="localization-list">
                                                ...
                                                <div>
                                                    <div class="form-check form-check-md form-switch">
                                                        <input id="reservation" name="reservation" class="form-check-input form-label" type="checkbox" role="switch" checked aria-checked="true">
                                                    </div>
                                    ...
                                    <div class="localization-content border-0">
                                        <div>
                                            ...
                                            <div class="localization-list">
                                                ...
                                                <div>
                                                    <div class="form-check form-check-md form-switch">
                                                        <input id="seasonalPricing" name="seasonalPricing" class="form-check-input form-label" type="checkbox" role="switch" checked aria-checked="true">
                                                    </div>
                                            ...
                                            <div class="localization-list">
                                                ...
                                                <div>
                                                    <div class="form-check form-check-md form-switch">
                                                        <input id="extraService" name="extraService" class="form-check-input form-label" type="checkbox" role="switch" checked aria-checked="true">
                                                    </div>
