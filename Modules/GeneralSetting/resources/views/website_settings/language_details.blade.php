                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <a href="javascript:void(0);" class="btn btn-white me-2">
                            <img src="assets/img/flags/uae.svg" alt="img" id="lngicon" class="avatar avatar-sm rounded-circle me-1">
...
@endsection
@push('scripts')
    <script src="{{ asset('assets/js/general_setting/language_details.js') }}"></script>
@endpush