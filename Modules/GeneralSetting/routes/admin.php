...
if (! function_exists('registerAdminProfileRoutes')) {
    function registerAdminProfileRoutes(): void
    {
...
if (! function_exists('registerAdminContentRoutes')) {
    function registerAdminContentRoutes(): void
    {
