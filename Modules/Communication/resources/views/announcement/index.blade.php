			...
			<form id="announcementForm" autocomplete="off">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<div class="mb-3">
								<label for="announcement_title" class="form-label">{{ __('admin.support.announcement_title') }}<span class="text-danger"> *</span></label>
						...
						<div class="col-md-6">
							<div class="mb-3">
								<label for="user_type" class="form-label">{{ __('admin.common.user') }}<span class="text-danger"> *</span></label>
			...
			<form id="editAnnouncementForm" autocomplete="off">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<div class="mb-3">
								<label for="edit_announcement_title" class="form-label">{{ __('admin.support.announcement_title') }}<span class="text-danger"> *</span></label>
						...
						<div class="col-md-6">
							<div class="mb-3">
								<label for="edit_user_type" class="form-label">{{ __('admin.common.user') }}<span class="text-danger"> *</span></label>
						...
						<div class="col-md-12">
							<div class="mb-3">
								<label for="edit_description" class="form-label">{{ __('admin.common.description') }}<span class="text-danger"> *</span></label>
