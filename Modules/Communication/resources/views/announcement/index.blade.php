...
<div class="page-wrapper">
    <div class="content me-4">
        <x-admin.breadcrumb :title="__('admin.support.announcements')" :breadcrumbs="[
				__('admin.support.announcements') => ''
			]" :buttonText="__('admin.support.add_new_announcement')" :modalId="'add_announcement_modal'"
            :buttonId="'add_announcement'" :permissionModule="'announcements'" />
        <!-- Table Header -->
            ...
            <div class="d-flex align-items-center flex-wrap row-gap-3">
                ...
                <div class="dropdown me-2">
                    <button type="button" class="dropdown-toggle btn btn-white d-inline-flex align-items-center"
                        data-bs-toggle="dropdown" id="sortDropdownBtn">
                        <i class="ti ti-filter me-1"></i> {{ __('admin.common.sort_by') }}: <span
                            id="currentSort">Latest</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end p-2">
                        <li><button type="button" class="dropdown-item rounded-1 sort-filter"
                                data-sort="latest">{{ __('admin.common.latest') }}</button></li>
                        <li><button type="button" class="dropdown-item rounded-1 sort-filter"
                                data-sort="ascending">{{ __('admin.common.ascending') }}</button></li>
                        <li><button type="button" class="dropdown-item rounded-1 sort-filter"
                                data-sort="descending">{{ __('admin.common.descending') }}</button></li>
                        <li><button type="button" class="dropdown-item rounded-1 sort-filter"
                ...
                <div class="dropdown me-2">
                    <button type="button" class="dropdown-toggle btn btn-white d-inline-flex align-items-center"
                        ...
                        <i class="ti ti-badge me-1"></i> {{ __('admin.common.status') }}: <span
                            id="currentStatus">All</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end p-2">
                        <li><button type="button" class="dropdown-item rounded-1 status-filter"
                                data-status="all">{{ __('admin.common.all') }}</button></li>
                        <li><button type="button" class="dropdown-item rounded-1 status-filter"
                                data-status="1">{{ __('admin.common.active') }}</button></li>
                        <li><button type="button" class="dropdown-item rounded-1 status-filter"
                                data-status="0">{{ __('admin.common.inactive') }}</button></li>
                    </ul>
                </div>
            </div>
            ...
            <table class="table" id="announcementTable">
                <thead class="thead-light">
                    <tr>
                        ...
                        @if (hasPermission($permissions, 'announcements', 'edit') || hasPermission($permissions,
            ...
            <form id="announcementForm" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="announcement_title"
                                    class="form-label">{{ __('admin.support.announcement_title') }}<span
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="user_type" class="form-label">{{ __('admin.common.user') }}<span
                                        class="text-danger"> *</span></label>
                                <select class="select select2" id="user_type" name="user_type"
            ...
            <form id="editAnnouncementForm" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_announcement_title"
                                    class="form-label">{{ __('admin.support.announcement_title') }}<span
                                        class="text-danger"> *</span></label>
                                <input type="text" class="form-control" name="edit_announcement_title"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="edit_user_type" class="form-label">{{ __('admin.common.user') }}<span
                                        class="text-danger"> *</span></label>
                                <select class="select select2" id="edit_user_type" name="edit_user_type"
                                    data-placeholder="{{ __('admin.common.select') }}">
                                    <option value="">{{ __('admin.common.select') }}</option>
                                    <option value="user">{{ __('admin.common.user') }}</option>
                                    <option value="admin">{{ __('admin.common.admin') }}</option>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label for="edit_description"
                                    class="form-label">{{ __('admin.common.description') }}<span class="text-danger">
                                        *</span></label>
