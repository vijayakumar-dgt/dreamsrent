...
@section('meta_title', __('admin.reports.earning_report') . ' || ' . $companyName)
    ...
    <div class="page-wrapper">
        <div class="content me-4">
            ...
            <div class="custom-datatable-filter table-responsive brandstable country-table">
                <table class="table datatable" id="earningTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="text-gray-9">
                                    {{ $booking->payment_type === 'cod' ? strtoupper($booking->payment_type) : ucfirst($booking->payment_type ?? '-') }}
                                </p>
                            </td>
                            <td>
                ...
                <div class="p-3">
                    {{ $bookingCount->links('vendor.pagination.custom-bootstrap-5') }}
                </div>
            </div>
        </div>
