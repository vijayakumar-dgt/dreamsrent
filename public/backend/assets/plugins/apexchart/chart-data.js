...
$(document).ready(function () {
  ...
  if($('#income_expense_chart').length > 0) {
    var options = {
      series: [{
      name: 'Sales',
      ...
      var chart = new ApexCharts(document.querySelector("#income_expense_chart"), options);
      chart.render();
    }
...
if ($('#total-bookings').length > 0) {
  ...
  var chart = new ApexCharts(document.querySelector("#total-bookings"), options);
  chart.render();
}
...
xaxis: {
  ...
  var chart = new ApexCharts(document.querySelector("#statistics_chart"), options);
  chart.render();
}
