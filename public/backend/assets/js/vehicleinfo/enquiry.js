(async () => {
    ...
    function initTable() {
        const status =
            $(".dropdown-menu .active-status.active").data("value") || "";
        const sortBy =
            $(".sort_by_list .dropdown-item.active").data("value") || "latest";
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.success && response.data.length > 0) {
                            ...
                            <td>
                                <span class="badge ${
                                    ...
                                    <i class="ti ti-point-filled me-1"></i>${
                                        value.status == 1
                                            ? `${_l("admin.common.not_opened")}`
                                            : value.status == 2
                                            ? `${_l("admin.common.opened")}`
                                            : value.status == 3
                                            ? `${_l("admin.common.closed")}`
                                            : "Unknown"
                                    }
                                </span>
                            </td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end p-2 shadow-sm">
                                        ${
                                            hasPermission(
                                                ...
                                                ? `
                                            <li>
                                                <button type="button" class="dropdown-item rounded-1 edit-enquiry" data-id="${
                                                    value.id
                                                }"
                                        ...
                                        ${
                                            hasPermission(
                                                ...
                                                ? `
                                        <li>
                                            <button type="button" class="dropdown-item rounded-1 delete-enquiry" data-id="${
                                                value.id
                                            }"
                    ...
                    tableBody = `<tr><td colspan="9" class="text-center">${_l(
