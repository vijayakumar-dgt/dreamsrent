(async () => {
        ...
        $("#inspectionForm").validate({
            ...
            messages: {
                ...
                inspection_date: {
                    ...
                    uniqueInspection: _l(
                        "admin.rentals.inspection_date_overlap"
                    ),
                },
                inspection_by: {
    ...
    function initEvents() {
        ...
        $(document).on("click", "#add_new_inspection", function () {
            $("#add_inspection .modal-title").text(
                _l("admin.rentals.create_inspection")
            );
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (
                    ...
                    !$.fn.DataTable.isDataTable("#inspectionTable")
                ) {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.code === 200) {
                    ...
                    $("#add_inspection #inspection_status")
                        .val(data.inspection_status)
                        .trigger("change");
                    $("#add_inspection #repair_status")
                        .val(data.repair_status)
                        .trigger("change");
                    $("#add_inspection .modal-title").text(
                        _l("admin.rentals.edit_inspection")
                    );
                    $("#add_inspection .submitbtn").text(
                        _l("admin.common.save_changes")
                    );
                    $(".error-text").text("");
                    $(".form-control").removeClass("is-invalid is-valid");
            ...
            case "completed":
                inspection_status = `
                    <span class="badge badge-soft-success d-inline-flex align-items-center">
                        <i class="ti ti-circle-filled fs-5 me-1"></i>${_l(
