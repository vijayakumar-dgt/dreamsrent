(async () => {
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-2">
                                    ${
                                        hasPermission(
                                            ...
                                            ? `<li>
                                        <button type="button" class="dropdown-item rounded-1 editCylinder" data-id="${
                                            row.id
                                    ...
                                    ${
                                        hasPermission(
                                            ...
                                            ? `<li>
                                        <button type="button" class="dropdown-item rounded-1 deleteCylinder" data-id="${
                                            row.id
    ...
    function initEvents() {
        ...
        $(document).on("click", "#add_new_cylinder", function () {
            $("#add_cylinder .modal-title").text(
                _l("admin.rentals.create_cylinder_type")
            );
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.code === 200) {
                        ...
                        $("#add_cylinder #cylinder_type").val(
                            data.cylinder_type
                        );
                        ...
                        $("#add_cylinder .modal-title").text(
                            _l("admin.rentals.edit_cylinder_type")
                        );
                        $("#add_cylinder .submitbtn").text(
                            _l("admin.common.save_changes")
                        );
                        $("#status_div").show();
