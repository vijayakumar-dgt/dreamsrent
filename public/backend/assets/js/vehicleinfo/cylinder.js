                ...
                { data: "id", render: function(data, type, row){
                    return `<div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-2">
                                    ...
                                    `<li>
                                        <button type="button" class="dropdown-item rounded-1 editCylinder" data-id="${row.id}"><i class="ti ti-edit me-1"></i>${_l('admin.common.edit')}</button>
                                    </li>`:''}
                                    ${ hasPermission(permissions, 'vehicle_attributes', 'delete') ? 

                                    `<li>
                                        <button type="button" class="dropdown-item rounded-1 deleteCylinder" data-id="${row.id}" data-bs-toggle="modal" data-bs-target="#delete-modal"><i class="ti ti-trash me-1"></i>${_l('admin.common.delete')}</button>
                                    </li>`:''}
                                </ul>
                            </div>`;
                    },
