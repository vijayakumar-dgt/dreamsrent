(async () => {
    ...
    $(document).ready(function () {
        ...
        function initInternationalPhoneInput() {
            const userPhoneInput = document.querySelector(
                ".driver_phone_number"
            );
        ...
        function initValidation() {
            $("#driverForm").validate({
                ...
                messages: {
                    ...
                    "documents[]": {
                        ...
                        filesize: _l("admin.manage.documents_size", {
                            size: 5,
                        }),
                    },
                },
            ...
            $("#editDriverForm").validate({
                ...
                submitHandler: function (form) {
                    ...
                    formData.set(
                        "phone_number",
                        $("#edit_international_phone_number").val()
                    );
        ...
        function initEvents() {
                ...
                if (file) {
                    ...
                    img.onload = function () {
                        if (this.width < 180 || this.height < 180) {
                            $("#image_error").text(
                                "Image must be at least 180x180 pixels."
                            );
                            $("#image")
                                .addClass("is-invalid")
                                .removeClass("is-valid");
            ...
            $(".bulk_status_change").on("click", function () {
                ...
                if (selectedIds.length === 0) {
                    showToast(
                        "error",
                        _l("admin.common.select_atleast_one_item_change_status")
                    );
                    return;
                }
                    ...
                    success: function (response) {
                        ...
                        if (response.code === 200) {
                            ...
                            const phoneInput = document.querySelector(
                                ".edit_driver_phone_number"
                            );
                            const hiddenInput = document.querySelector(
                                "#edit_international_phone_number"
                            );
            ...
            $("#driverTable").DataTable({
                ...
                ajax: {
                    ...
                    complete: function () {
                        ...
                        if (
                            $("#driverTable").DataTable().rows().count() === 0
                        ) {
                        ...
                        render: function (data, type, row) {
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar rounded-circle me-2 flex-shrink-0">
                                    <img src="${
                                        row.image
                                    }" class="rounded-circle" alt="Image Preview">
                                </div>
                                <div>
                                    <h6 class="fs-14 fw-semibold text-black">${ucfirst(
                                        row.driver_name
                                    )}</h6>
                                ...
                                <div class="dropdown">
                                    ...
                                    ${
                                        hasPermission(
                                            ...
                                            ? `<li>
                                            <button type="button" class="dropdown-item rounded-1 edit-driver" data-id="${
                                                row.id
                                        ...
                                        ${
                                            hasPermission(
                                                ...
                                                ? `<li>
                                            <button type="button" class="dropdown-item rounded-1 delete-driver" data-id="${
                                                row.id
