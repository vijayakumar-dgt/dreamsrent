...
(function () {
    ...
    $(document).on("mouseover", function (e) {
        ...
        if (
            ...
            var targ = $(e.target).closest(
                ".sidebar, .header-left, #toggle_btn"
            ).length;
            if (targ) {
    ...
    if ($(".unlimited-checkbox").length > 0) {
        $(".unlimited-checkbox input[type='checkbox']").on(
            "change",
            function () {
                let unlimitedWrap = $(this)
                    .closest(".unlimited-price")
                    .find(".unlimited-wrap input");
    ...
    $(".add-new-benifit-2").on("click", function () {
        var servicecontent =
            '<div class="mb-1 extra-benifit-row-2">' +
            '<div class="d-flex align-items-center">' +
