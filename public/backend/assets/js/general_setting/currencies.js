...
(async () => {
    ...
    $(document).ready(function(){
        ...
        $("#currencyForm").validate({
            ...
            messages:{
                ...
                symbol: {
                    required: _l('admin.general_settings.enter_currency_symbol'),
                }
            },
            ...
            submitHandler: function(form) {
               ...
               $.ajax({
                    ...
                    success:function(resp){
                        ...
                        $("#currencyForm .submitbtn").text($("#id").val() ? _l('admin.common.save_changes') : _l('admin.common.create_new'));
        ...
        $.ajax({
             ...
             success:function(response){
               if(response && response.code === 200){
                   ...
                   $("#currencyForm .submitbtn").text(_l('admin.common.save_changes'));
                   $("#currencyForm .submitbtn").prop('disabled', false);
    ...
    $("#deleteCurrencyForm").on("submit", function(e){
       ...
       $("#deleteCurrencyForm .submitbtn").text(_l('admin.general_settings.please_wait'));
       $.ajax({
           type:"POST",
           ...
           success:function(response){
               ...
               $("#deleteCurrencyForm .submitbtn").text(_l('admin.general_settings.yes_delete'));
