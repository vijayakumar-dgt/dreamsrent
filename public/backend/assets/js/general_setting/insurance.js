    ...
    $(document).ready(function () {
        ...
        $("#insuranceForm").validate({
            ...
            messages: {
                insurance_name: {
                    required: _l(
                        "admin.general_settings.insurance_name_required"
                    ),
                    minlength: _l(
                        "admin.general_settings.insurance_name_minlength"
                    ),
                    maxlength: _l(
                        "admin.general_settings.insurance_name_maxlength"
                    ),
                },
                price_type_id: {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.code === 200) {
                ...
                $(
                    `input[name="price_type_id"][value="${data.price_type_id}"]`
                ).prop("checked", true);
                ...
                if (data.insurance_benefits) {
                    ...
                    $.each(data.insurance_benefits, function (index, value) {
                        ...
                        newInput.rules("add", {
                            ...
                            messages: {
                                required: _l(
                                    "admin.general_settings.benefit_required"
                                ),
                            },
                        });
                    });
