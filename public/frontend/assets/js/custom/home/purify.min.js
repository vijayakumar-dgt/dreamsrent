    ...
    var V = (function t() {
                    ...
                    if (
                        ...
                        (Fe =
                            "FORBID_CONTENTS" in e
                                ? N({}, e.FORBID_CONTENTS, et)
                                : He),
                        (Ee =
                            "FORBID_TAGS" in e ? N({}, e.FORBID_TAGS, et) : {}),
                        (Ae =
                            "FORBID_ATTR" in e ? N({}, e.FORBID_ATTR, et) : {}),
                        ...
                        Pe &&
                            ...
                            !0 === Pe.svgFilters &&
                                (N(de, L), N(ge, I), N(ge, U)),
                            !0 === Pe.mathMl && (N(de, x), N(ge, M), N(ge, U))),
                        e.ADD_TAGS &&
                            (de === he && (de = S(de)), N(de, e.ADD_TAGS, et)),
                        e.ADD_ATTR &&
                            (ge === Te && (ge = S(ge)), N(ge, e.ADD_ATTR, et)),
        ...
        const mt = function (e) {
                        ...
                        !(
                            (At(e) &&
                                ...
                                ((ye.attributeNameCheck instanceof RegExp &&
                                    ...
                                    (ye.attributeNameCheck instanceof
                                        Function &&
            ...
            bt = function e(t) {
                ...
                const o = dt(t);
                for (
                    Tt("beforeSanitizeShadowDOM", t, null);
                    (n = o.nextNode());

                )
                    Tt("uponSanitizeShadowNode", n, null),
                        yt(n) ||
                            (n.content instanceof c && e(n.content), _t(n));
