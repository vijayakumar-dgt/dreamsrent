    ...
    $("#companySettingForm").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                complete: function () {
                    $('.companysave').attr('disabled', false).html(_l('admin.common.save_changes'));
                },
    ...
    $(document).ready(function() {
        $("#ownerSettingForm").validate({
            ...
            submitHandler: function(form) {
                ...
                $(".ownershipChange").text('Please Wait...').prop('disabled', true);
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        if (resp.code === 200) {
                            showToast('success', resp.message);
                            $(".ownershipChange").text('Update').prop('disabled', false);
                        }
                    },
                    error: function(error) {
                        $(".error-text").text("");
