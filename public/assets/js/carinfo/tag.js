                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end p-2">
                                            ${hasPermission(permissions, 'vehicle_attributes', 'edit') ?
                                                `<li>
                                                    <a class="dropdown-item rounded-1" href="javascript:void(0);" id="editTag" data-id="${value.id}"><i class="ti ti-edit me-1"></i>${_l('admin.common.edit')}</a>
                                                </li>` : ''}
                                            ${hasPermission(permissions, 'vehicle_attributes', 'delete') ?
                                                `<li>
                                                    <a class="dropdown-item rounded-1" href="javascript:void(0);" id="deleteTag" data-id="${value.id}" data-bs-toggle="modal" data-bs-target="#delete-modal"><i class="ti ti-trash me-1"></i>${_l('admin.common.delete')}</a>
                                                </li>` : ''}
                                        </ul>
                                    </div>
                                </td>` : ''}
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.code === 200) {
                        ...
                        $("#add_tag #status").prop('checked', data.status === 1);
