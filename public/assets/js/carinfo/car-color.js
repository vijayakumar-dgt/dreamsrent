        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.code === 200 && response.data.length > 0) {
                                ...
                                `<td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end p-2">
                                            ...
                                            `<li>
                                                <a class="dropdown-item rounded-1" href="javascript:void(0);" onclick="editCarColor(${value.id});"><i class="ti ti-edit me-1"></i>${_l('admin.common.edit')}</a>
                                            </li>`: ''}
                                            ${ hasPermission(permissions, 'vehicle_attributes', 'delete') ? 
                                            `<li>
                                                <a class="dropdown-item rounded-1" href="javascript:void(0);" onclick="deleteCarColor(${value.id});" data-bs-toggle="modal" data-bs-target="#delete-modal"><i class="ti ti-trash me-1"></i>${_l('admin.common.delete')}</a>
                                            </li>`:''
                                            }                                        
                                        </ul>
                                    </div>
                    ...
                    tableBody += `
                            <tr>
                                <td colspan="5" class="text-center">${_l('admin.common.empty_table')}</td></td>
                            </tr>`;
                    $('.table-footer').empty();
                }
